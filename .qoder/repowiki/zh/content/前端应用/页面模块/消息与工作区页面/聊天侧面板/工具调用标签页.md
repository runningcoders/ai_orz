...
## 更新摘要
**所做更改**
- 新增了 ChatSidePanel 工具调用标签页功能，显示最近工具执行记录与运行中进程的关联
...
- **新增功能**：聊天侧栏的"工具调用"Tab，展示最近工具调用记录并与运行中进程关联
...
**图表来源**
- [src/router.rs:739-753](file://src/router.rs#L739-L753)
...
**章节来源**
- [frontend/src/components/chat/tool_calls_tab.rs:1-373](file://frontend/src/components/chat/tool_calls_tab.rs#L1-L373)
...
- **新增功能**：通过聊天侧栏"工具调用"Tab 直观展示执行轨迹，并与运行中进程联动
