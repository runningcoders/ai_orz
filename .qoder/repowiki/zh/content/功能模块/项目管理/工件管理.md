...
- [artifact.rs（枚举）](file://common/src/enums/artifact.rs)
- [artifact.rs（API DTO）](file://common/src/api/artifact.rs)
- [artifact.rs（领域层）](file://src/service/domain/project/artifact.rs)
- [artifact.rs（DAL）](file://src/service/dal/artifact.rs)
- [sqlite.rs（DAO 实现）](file://src/service/dao/artifact/sqlite.rs)
- [mod.rs（处理器模块）](file://src/handlers/project/artifact/mod.rs)
...
- [2026-07-28-artifact-editing.md](file://docs/superpowers/plans/2026-07-28-artifact-editing.md)
- [2026-07-28-agent-artifact-creation-proposal.md](file://docs/superpowers/plans/2026-07-28-agent-artifact-creation-proposal.md)
</cite>
...
图示来源
- [mod.rs（处理器模块）:1-24](file://src/handlers/project/artifact/mod.rs#L1-L24)
- [artifact.rs（领域层）:26-211](file://src/service/domain/project/artifact.rs#L26-L211)
- [artifact.rs（DAL）:37-91](file://src/service/dal/artifact.rs#L37-L91)
- [sqlite.rs（DAO 实现）:62-335](file://src/service/dao/artifact/sqlite.rs#L62-L335)
...
章节来源
- [artifact.rs（模型）:17-338](file://src/models/artifact.rs#L17-L338)
- [artifact.rs（枚举）:8-62](file://common/src/enums/artifact.rs#L8-L62)
- [artifact.rs（领域层）:26-532](file://src/service/domain/project/artifact.rs#L26-L532)
- [artifact.rs（DAL）:37-196](file://src/service/dal/artifact.rs#L37-L196)
- [sqlite.rs（DAO 实现）:62-361](file://src/service/dao/artifact/sqlite.rs#L62-L361)
- [artifact.rs（API DTO）:9-269](file://common/src/api/artifact.rs#L9-L269)
...
- [artifact.rs（DAL）:101-105](file://src/service/dal/artifact.rs#L101-L105)
- [sqlite.rs（DAO 实现）:64-105](file://src/service/dao/artifact/sqlite.rs#L64-L105)
...
章节来源
- [artifact.rs（枚举）:8-62](file://common/src/enums/artifact.rs#L8-L62)
- [project_management_design.md:90-98](file://docs/project_management_design.md#L90-L98)
- [create_artifact.rs:37-53](file://src/handlers/project/artifact/create_artifact.rs#L37-L53)
...
章节来源
- [artifact.rs（模型）:17-48](file://src/models/artifact.rs#L17-L48)
- [artifact.rs（模型）:304-314](file://src/models/artifact.rs#L304-L314)
- [sqlite.rs（DAO 实现）:246-286](file://src/service/dao/artifact/sqlite.rs#L246-L286)
...
章节来源
- [project_management_design.md:310-314](file://docs/project_management_design.md#L310-L314)
- [artifact.rs（领域层）:273-340](file://src/service/domain/project/artifact.rs#L273-L340)
- [2026-07-28-artifact-editing.md:45-87](file://docs/superpowers/plans/2026-07-28-artifact-editing.md#L45-L87)
...
章节来源
- [create_artifact.rs:55-146](file://src/handlers/project/artifact/create_artifact.rs#L55-L146)
- [update_artifact.rs:1-54](file://src/handlers/project/artifact/update_artifact.rs#L1-L54)
- [artifact.rs（领域层）:224-271](file://src/service/domain/project/artifact.rs#L224-L271)
- [sqlite.rs（DAO 实现）:288-334](file://src/service/dao/artifact/sqlite.rs#L288-L334)
...
章节来源
- [sqlite.rs（DAO 实现）:123-159](file://src/service/dao/artifact/sqlite.rs#L123-L159)
- [sqlite.rs（DAO 实现）:337-361](file://src/service/dao/artifact/sqlite.rs#L337-L361)
- [project_management_design.md:310-383](file://docs/project_management_design.md#L310-L383)
...
- [sqlite.rs（DAO 实现）:41-59](file://src/service/dao/artifact/sqlite.rs#L41-L59)
- [create_artifact.rs:118-122](file://src/handlers/project/artifact/create_artifact.rs#L118-L122)
- [update_artifact.rs:27-36](file://src/handlers/project/artifact/update_artifact.rs#L27-L36)
...
章节来源
- [artifact.rs（领域层）:167-211](file://src/service/domain/project/artifact.rs#L167-L211)
- [2026-07-28-agent-artifact-creation-proposal.md:62-107](file://docs/superpowers/plans/2026-07-28-agent-artifact-creation-proposal.md#L62-L107)
- [2026-07-28-agent-artifact-creation-proposal.md:109-131](file://docs/superpowers/plans/2026-07-28-agent-artifact-creation-proposal.md#L109-L131)
...
章节来源
- [sqlite.rs（DAO 实现）:41-59](file://src/service/dao/artifact/sqlite.rs#L41-L59)
- [project_management_design.md:325-328](file://docs/project_management_design.md#L325-L328)
...
章节来源
- [create_artifact.rs:26-53](file://src/handlers/project/artifact/create_artifact.rs#L26-L53)
- [update_artifact.rs:27-54](file://src/handlers/project/artifact/update_artifact.rs#L27-L54)
- [sqlite.rs（DAO 实现）:41-59](file://src/service/dao/artifact/sqlite.rs#L41-L59)
- [artifact.rs（领域层）:273-340](file://src/service/domain/project/artifact.rs#L273-L340)
