...
- [项目模型（Project/Task）](file://src/models/project.rs)
- [任务模型（Task）](file://src/models/task.rs)
- [项目 API DTO](file://common/src/api/project.rs)
- [任务 API DTO](file://common/src/api/task.rs)
- [项目 DAL](file://src/service/dal/project.rs)
- [项目 Domain 入口与能力定义](file://src/service/domain/project/mod.rs)
</cite>
...
图表来源
- [项目 DAL:1-209](file://src/service/dal/project.rs#L1-L209)
- [项目 Domain 入口与能力定义:91-226](file://src/service/domain/project/mod.rs#L91-L226)

章节来源
- [项目管理系统设计文档:11-36](file://docs/project_management_design.md#L11-L36)
- [项目 DAL:29-67](file://src/service/dal/project.rs#L29-L67)
- [项目 Domain 入口与能力定义:63-89](file://src/service/domain/project/mod.rs#L63-L89)
...
章节来源
- [项目模型（Project/Task）:15-80](file://src/models/project.rs#L15-L80)
- [任务模型（Task）:16-81](file://src/models/task.rs#L16-L81)
- [项目 Domain 入口与能力定义:91-498](file://src/service/domain/project/mod.rs#L91-L498)
- [项目 DAL:71-209](file://src/service/dal/project.rs#L71-L209)
...
图表来源
- [项目 API DTO:10-31](file://common/src/api/project.rs#L10-L31)
- [项目 Domain 入口与能力定义:111-129](file://src/service/domain/project/mod.rs#L111-L129)
- [项目 DAL:223-274](file://src/service/dal/project.rs#L223-L274)

章节来源
- [项目管理系统设计文档:138-161](file://docs/project_management_design.md#L138-L161)
- [项目 DAL:223-274](file://src/service/dal/project.rs#L223-L274)
...
图表来源
- [项目系统设计文档:31-43](file://docs/project_design.md#L31-L43)
- [项目 Domain 入口与能力定义:184-225](file://src/service/domain/project/mod.rs#L184-L225)
...
图表来源
- [项目管理系统设计文档:258-289](file://docs/project_management_design.md#L258-L289)
- [任务模型（Task）:37-63](file://src/models/task.rs#L37-L63)
...
图表来源
- [项目模型（Project/Task）:60-80](file://src/models/project.rs#L60-L80)
- [任务模型（Task）:65-81](file://src/models/task.rs#L65-L81)

章节来源
- [项目模型（Project/Task）:317-359](file://src/models/project.rs#L317-L359)
- [任务模型（Task）:172-214](file://src/models/task.rs#L172-L214)
...
图表来源
- [项目管理系统设计文档:332-406](file://docs/project_management_design.md#L332-L406)
- [项目 Domain 入口与能力定义:465-498](file://src/service/domain/project/mod.rs#L465-L498)

章节来源
- [项目管理系统设计文档:316-406](file://docs/project_management_design.md#L316-L406)
- [项目 Domain 入口与能力定义:361-498](file://src/service/domain/project/mod.rs#L361-L498)
...
图表来源
- [项目 DAL:488-703](file://src/service/dal/project.rs#L488-L703)
...
章节来源
- [项目模型（Project/Task）:24-27](file://src/models/project.rs#L24-L27)
- [任务模型（Task）:37-63](file://src/models/task.rs#L37-L63)
- [项目管理系统设计文档:544-670](file://docs/project_management_design.md#L544-L670)
...
章节来源
- [项目系统设计文档:70-83](file://docs/project_design.md#L70-L83)
- [项目管理系统设计文档:544-670](file://docs/project_management_design.md#L544-L670)
...
章节来源
- [项目 DAL:183-202](file://src/service/dal/project.rs#L183-L202)
- [项目模型（Project/Task）:60-80](file://src/models/project.rs#L60-L80)
- [任务模型（Task）:65-81](file://src/models/task.rs#L65-L81)
...
章节来源
- [项目管理系统设计文档:291-307](file://docs/project_management_design.md#L291-L307)
- [项目 DAL:448-456](file://src/service/dal/project.rs#L448-L456)
...
章节来源
- [项目系统设计文档:77-83](file://docs/project_design.md#L77-L83)
- [项目 Domain 入口与能力定义:111-129](file://src/service/domain/project/mod.rs#L111-L129)
- [项目管理系统设计文档:544-670](file://docs/project_management_design.md#L544-L670)
...
图表来源
- [项目 DAL:213-221](file://src/service/dal/project.rs#L213-L221)
...
章节来源
- [项目 API DTO:10-255](file://common/src/api/project.rs#L10-L255)
- [任务 API DTO:10-299](file://common/src/api/task.rs#L10-L299)
- [项目管理系统设计文档:472-498](file://docs/project_management_design.md#L472-L498)