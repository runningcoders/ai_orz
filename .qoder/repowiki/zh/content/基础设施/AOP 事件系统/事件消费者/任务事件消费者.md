...
- [task_status.rs（事件定义）](file://src/models/events/task_status.rs)
- [task.rs（DAL update_status 发布事件）](file://src/service/dal/task.rs)
- [message/mod.rs（MessageDomain 与去重接口）](file://src/service/domain/message/mod.rs)
- [message.rs（消息消费者，上下文补充与调度）](file://src/consumer/message.rs)
- [aop/mod.rs（AOP 框架入口）](file://src/pkg/aop/mod.rs)
- [core/mod.rs（AOP 核心导出）](file://src/pkg/aop/core/mod.rs)
- [project_management_design.md（任务依赖 DAG 规则）](file://docs/project_management_design.md)
</cite>
...
- [task.rs:619-643](file://src/service/dal/task.rs#L619-L643)
- [message/mod.rs:98-117](file://src/service/domain/message/mod.rs#L98-L117)
- [message.rs:64-141](file://src/consumer/message.rs#L64-L141)
- [aop/mod.rs:1-46](file://src/pkg/aop/mod.rs#L1-L46)
...
章节来源
- [task_event_consumer.rs:24-137](file://src/consumer/task_event_consumer.rs#L24-L137)
- [task_status.rs:12-66](file://src/models/events/task_status.rs#L12-L66)
- [message/mod.rs:98-117](file://src/service/domain/message/mod.rs#L98-L117)
- [message.rs:64-141](file://src/consumer/message.rs#L64-L141)
- [aop/mod.rs:1-46](file://src/pkg/aop/mod.rs#L1-L46)
...
章节来源
- [message.rs:64-141](file://src/consumer/message.rs#L64-L141)
- [message.rs:479-514](file://src/consumer/message.rs#L479-L514)
...
章节来源
- [task_event_consumer.rs:85-103](file://src/consumer/task_event_consumer.rs#L85-L103)
...
章节来源
- [project_management_design.md:256-290](file://docs/project_management_design.md#L256-L290)
...
章节来源
- [task_event_consumer.rs:125-133](file://src/consumer/task_event_consumer.rs#L125-L133)
