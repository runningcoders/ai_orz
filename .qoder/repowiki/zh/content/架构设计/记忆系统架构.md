...
## 更新摘要
**变更内容**
- 新增用户偏好沉淀机制章节，说明双源画像设计（用户表自述 + 组织级图谱总结）
...
**更新** 本次更新新增了用户偏好沉淀机制，实现了声明式用户自述偏好与推断式 Agent 观察总结的双源画像体系，并在唤醒链路中自动注入用户画像到 Prompt。
...
- [src/consumer/message.rs:340-346](file://src/consumer/message.rs#L340-L346)
...
**更新** 本次新增的用户偏好沉淀机制进一步完善了记忆系统的画像能力，通过声明式自述与推断式总结的双源设计，既保证了用户自主权，又实现了 Agent 观察的持续演进。唤醒链路的自动画像注入让 Agent 能够基于完整的用户上下文提供更个性化的服务。
