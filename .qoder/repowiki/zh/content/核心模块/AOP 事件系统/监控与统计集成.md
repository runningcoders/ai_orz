...
<cite>
**本文引用的文件**
- [metrics_hook.rs](file://src/pkg/aop/core/metrics_hook.rs)
...
- [aop_stats.rs（handlers）](file://src/handlers/system/aop_stats.rs)
- [aop_stats.rs（domain）](file://src/service/domain/system/aop_stats.rs)
...
图表来源
- [metrics_hook.rs:1-90](file://src/pkg/aop/core/metrics_hook.rs#L1-L90)
- [registry.rs:44-73](file://src/pkg/aop/core/registry.rs#L44-L73)
...
- [aop_stats.rs（handlers）:1-73](file://src/handlers/system/aop_stats.rs#L1-L73)

章节来源
- [mod.rs（consumer）:1-42](file://src/consumer/mod.rs#L1-L42)
- [aop_stats.rs（handlers）:1-73](file://src/handlers/system/aop_stats.rs#L1-L73)
...
- [aop_stats.rs（domain）:1-53](file://src/service/domain/system/aop_stats.rs#L1-L53)
- [aop_stats.rs（handlers）:1-73](file://src/handlers/system/aop_stats.rs#L1-L73)
...
- [tool_exec_stats_consumer.rs:1-73](file://src/consumer/tool_exec_stats_consumer.rs#L1-L73)
- [aop_stats.rs（handlers）:1-73](file://src/handlers/system/aop_stats.rs#L1-L73)
- [health_metrics.rs:1-26](file://src/handlers/system/health_metrics.rs#L1-L26)
