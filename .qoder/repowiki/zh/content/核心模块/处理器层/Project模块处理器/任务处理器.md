...
- [src/handlers/project/task/list_tasks.rs:1-37](file://src/handlers/project/task/list_tasks.rs#L1-L37)
- [src/handlers/project/task/query_tasks.rs:1-44](file://src/handlers/project/task/query_tasks.rs#L1-L44)
- [src/service/domain/project/mod.rs:91-359](file://src/service/domain/project/mod.rs#L91-L359)
- [src/service/dal/task.rs:72-207](file://src/service/dal/task.rs#L72-L207)
- [src/producer/a2a_polling.rs:218-271](file://src/producer/a2a_polling.rs#L218-L271)
- [src/handlers/a2a/callback.rs:160-197](file://src/handlers/a2a/callback.rs#L160-L197)
...
- [src/models/task.rs:83-235](file://src/models/task.rs#L83-L235)
- [src/models/task.rs:237-343](file://src/models/task.rs#L237-L343)
...
图表来源
- [src/handlers/project/task/create_task.rs:21-84](file://src/handlers/project/task/create_task.rs#L21-L84)
- [src/service/domain/project/mod.rs:249-265](file://src/service/domain/project/mod.rs#L249-L265)
...
- [src/service/domain/project/mod.rs:334-359](file://src/service/domain/project/mod.rs#L334-L359)
...
图表来源
- [src/handlers/project/task/query_tasks.rs:14-44](file://src/handlers/project/task/query_tasks.rs#L14-L44)
- [src/service/dal/task.rs:133-153](file://src/service/dal/task.rs#L133-L153)

章节来源
- [src/handlers/project/task/list_tasks.rs:11-37](file://src/handlers/project/task/list_tasks.rs#L11-L37)
- [src/handlers/project/task/query_tasks.rs:14-44](file://src/handlers/project/task/query_tasks.rs#L14-L44)
- [src/service/dal/task.rs:133-153](file://src/service/dal/task.rs#L133-L153)
...
- [docs/project_management_design.md:250-308](file://docs/project_management_design.md#L250-L308)
...
- [frontend/src/components/workspace_graph.rs:215-248](file://frontend/src/components/workspace_graph.rs#L215-L248)
...
章节来源
- [src/service/dal/task.rs:221-255](file://src/service/dal/task.rs#L221-L255)
- [src/service/dal/task.rs:143-153](file://src/service/dal/task.rs#L143-L153)
- [src/service/dal/task.rs:181-206](file://src/service/dal/task.rs#L181-L206)
...
- 创建任务：POST /api/v1/tasks
  - 参考：[src/handlers/project/task/create_task.rs:21-84](file://src/handlers/project/task/create_task.rs#L21-L84)
- 更新任务状态：PUT /api/v1/tasks/{id}/status
  - 参考：[src/handlers/project/task/update_task_status.rs:21-40](file://src/handlers/project/task/update_task_status.rs#L21-L40)
- 更新任务进度：PUT /api/v1/tasks/{id}/progress
  - 参考：[src/handlers/project/task/update_task_progress.rs:19-29](file://src/handlers/project/task/update_task_progress.rs#L19-L29)
- 列出任务：GET /api/v1/tasks
  - 参考：[src/handlers/project/task/list_tasks.rs:11-37](file://src/handlers/project/task/list_tasks.rs#L11-L37)
- 通用查询任务：POST /api/v1/tasks/query
  - 参考：[src/handlers/project/task/query_tasks.rs:14-44](file://src/handlers/project/task/query_tasks.rs#L14-L44)

### 数据库迁移（任务进度）
- 任务进度字段与索引：
  - 参考：[migrations/20260712000002_task_progress.sql](file://migrations/20260712000002_task_progress.sql)