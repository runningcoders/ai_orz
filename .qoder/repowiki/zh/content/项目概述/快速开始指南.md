...
- [ai_orz.toml:9-29](file://common/config/ai_orz.toml#L9-L29)
- [lib.rs:156-172](file://src/lib.rs#L156-L172)

章节来源
- [start.sh:1-232](file://start.sh#L1-L232)
- [ai_orz.toml:1-43](file://common/config/ai_orz.toml#L1-L43)
...
章节来源
- [start.sh:37-64](file://start.sh#L37-L64)
...
- [20260420000000_initial.sql:10-273](file://migrations/20260420000000_initial.sql#L10-L273)
...
- [start.sh:37-64](file://start.sh#L37-L64)
- [start.sh:66-107](file://start.sh#L66-L107)
- [start.sh:129-188](file://start.sh#L129-L188)
- [start.sh:190-203](file://start.sh#L190-L203)
...
- 环境变量可覆盖配置（如 SERVER_PORT、FRONTEND_DIST_DIR、JWT_SECRET、JWT_EXPIRY_HOURS 等）
...
图表来源
- [config.rs:26-78](file://src/config.rs#L26-L78)
- [ai_orz.toml:9-43](file://common/config/ai_orz.toml#L9-L43)
...
章节来源
- [20260420000000_initial.sql:1-273](file://migrations/20260420000000_initial.sql#L1-L273)
...
- [package.json:1-14](file://frontend/package.json#L1-L14)
