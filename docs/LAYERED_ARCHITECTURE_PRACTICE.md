...
> 🎯 **本文档定位**：开发者实操手册——怎么正确写分层代码、哪些坑不能踩、反模式长什么样（AGENTS.md §3.1 分层架构规范的配套示例化展开）
>
...
>
> 关联文档：
> - [AGENTS.md §3.1](../AGENTS.md) — 代码分层架构规范（权威定义层，本文档是其示例化展开）
> - [ARCHITECTURE.md](./ARCHITECTURE.md) — 唯一权威架构总纲（分层边界章节）
