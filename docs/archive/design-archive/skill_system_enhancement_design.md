...
> 📦 归档标记（2026-08-16）：归档冻结。保留原因：skill_system_enhancement_design 设计文档归档冻结，设计决策已沉淀至 wiki 长文。生效方案：见源码和 wiki 长文。
...
>   - [Agent管理集成测试.md](docs/archive/plan-archive/Agent管理集成测试.md) — 技能安装幂等测试 + 入职绑定失败降级 + Prompt Token 预算断言
