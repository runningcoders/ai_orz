...
> 📦 归档标记（2026-08-16）：归档冻结。保留原因：AOP生产消费事件中心重构 功能已完成并通过验收，文档转为历史快照。生效方案：见源码和 wiki 长文。
...
>   - [message_channel_design.md](../archive/design-archive/message_channel_design.md) — 消息渠道系统骨架（消息出站链路）
