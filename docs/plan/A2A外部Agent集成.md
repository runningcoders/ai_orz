...
>
> 关联文档：
> - [external_agent_design.md](../design/external_agent_design.md) — 外部 Agent 设计决策（架构决策+关键约束）
...
1. **A2A Server（让本 ai_orz 组织本身暴露 A2A endpoint，供外部调用）**：
   ...
   - 对应设计文档位置：[external_agent_design.md](../design/external_agent_design.md) 的"未来扩展 A2A Server"章
