...
- [src/service/domain/project/task.rs:18-526](src/service/domain/project/task.rs#L18-L526)
- [src/service/dal/task.rs:28-219](src/service/dal/task.rs#L28-L219)
...
章节来源
- [common/src/api/task.rs:100-299](common/src/api/task.rs#L100-L299)
...
- [src/service/dal/task.rs:221-255](src/service/dal/task.rs#L221-L255)
- [src/service/dal/task.rs:366-571](src/service/dal/task.rs#L366-L571)
- [src/service/dal/task.rs:690-721](src/service/dal/task.rs#L690-L721)
...
章节来源
- [src/service/domain/project/task.rs:394-482](src/service/domain/project/task.rs#L394-L482)
- [src/service/dal/task.rs:366-431](src/service/dal/task.rs#L366-L431)
- [src/service/dal/task.rs:221-255](src/service/dal/task.rs#L221-L255)
...
- 创建任务
  ...
  - 参考路径：[创建任务处理器:1-86](src/handlers/project/task/create_task.rs#L1-L86)、[领域创建:51-109](src/service/domain/project/task.rs#L51-L109)。
...
- 查询任务
  ...
  - 参考路径：[API 定义:38-299](common/src/api/task.rs#L38-L299)、[DAL 搜索:366-571](src/service/dal/task.rs#L366-L571)。

- 更新任务基本信息
  - 支持 title、description、priority、tags、due_at、dependencies、execution_plan、execution_result。
  - 参考路径：[领域更新:227-279](src/service/domain/project/task.rs#L227-L279)。

- 状态流转
  - 通过 UpdateTaskStatusRequest 指定目标状态；内部校验状态机并记录事件。
  - 参考路径：[状态更新处理器:1-41](src/handlers/project/task/update_task_status.rs#L1-L41)、[状态机实现:394-482](src/service/domain/project/task.rs#L394-L482)。

- 进度更新
  - 通过 UpdateTaskProgressRequest 设置 0-100 的进度；记录 progress_updated 事件。
  - 参考路径：[进度更新处理器:1-30](src/handlers/project/task/update_task_progress.rs#L1-L30)、[领域更新:484-524](src/service/domain/project/task.rs#L484-L524)。

- 完成标记
  - 通过 MarkDoneParams 指定 task_id；内部调用 complete 并记录 completed 事件。
  - 参考路径：[完成标记处理器:1-40](src/handlers/project/task/mark_done.rs#L1-L40)、[领域完成:317-356](src/service/domain/project/task.rs#L317-L356)。

- 状态机与进度字段
  - 状态枚举与转换：见 [任务状态枚举:8-47](common/src/enums/task.rs#L8-L47)。
  - 进度字段迁移：见 [任务进度迁移](migrations/20260712000002_task_progress.sql)。