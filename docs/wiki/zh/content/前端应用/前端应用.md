...
- [统计图表Phase1基础设施与时序图展示重构.md](docs/plan/统计图表Phase1基础设施与时序图展示重构.md) — Stats 面板 / LineChart 时序图等前端复合业务组件
- [知识图谱推荐起点与组件复用重构.md](docs/plan/知识图谱推荐起点与组件复用重构.md) — 知识图谱页面 + Agent 详情页 Tab 两端复用
