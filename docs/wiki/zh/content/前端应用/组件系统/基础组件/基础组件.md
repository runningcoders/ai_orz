...
- [frontend/src/components/confirm_dialog.rs](file://frontend/src/components/confirm_dialog.rs)
- [frontend/src/components/toast.rs](file://frontend/src/components/toast.rs)
- [frontend/src/store/toast.rs](file://frontend/src/store/toast.rs)
- [frontend/src/components/gauge.rs](file://frontend/src/components/gauge.rs)
...
- [frontend/src/components/confirm_dialog.rs:1-98](file://frontend/src/components/confirm_dialog.rs#L1-L98)
- [frontend/src/components/toast.rs:1-104](file://frontend/src/components/toast.rs#L1-L104)
- [frontend/src/store/toast.rs:1-112](file://frontend/src/store/toast.rs#L1-L112)
- [frontend/src/components/gauge.rs:1-324](file://frontend/src/components/gauge.rs#L1-L324)
- [frontend/src/components/aop_gauge.rs:1-116](file://frontend/src/components/aop_gauge.rs#L1-L116)
...
图表来源
- [frontend/src/components/confirm_dialog.rs:60-97](file://frontend/src/components/confirm_dialog.rs#L60-L97)
...
- [frontend/src/store/toast.rs:43-95](file://frontend/src/store/toast.rs#L43-L95)
...
图表来源
- [frontend/src/components/gauge.rs:24-64](file://frontend/src/components/gauge.rs#L24-L64)
- [frontend/src/components/gauge.rs:67-159](file://frontend/src/components/gauge.rs#L67-L159)
- [frontend/src/components/gauge.rs:161-257](file://frontend/src/components/gauge.rs#L161-L257)
- [frontend/src/components/hud_palette.rs:20-45](file://frontend/src/components/hud_palette.rs#L20-L45)
...
图表来源
- [frontend/src/components/aop_gauge.rs:44-87](file://frontend/src/components/aop_gauge.rs#L44-L87)
- [frontend/src/components/gauge.rs:67-159](file://frontend/src/components/gauge.rs#L67-L159)
...
图表来源
- [frontend/src/components/stats.rs:89-116](file://frontend/src/components/stats.rs#L89-L116)
- [frontend/src/components/stats.rs:118-261](file://frontend/src/components/stats.rs#L118-L261)
...
- 模态框无法关闭
  ...
  - 参考路径：[modal.rs:15-43](file://frontend/src/components/modal.rs#L15-L43)
- Toast 不消失或重复出现
  - 检查 duration_ms 与 dismiss 调用；确认 id 唯一且未被提前移除。
  - 参考路径：[toast.rs:27-93](file://frontend/src/components/toast.rs#L27-L93)、[store/toast.rs:52-73](file://frontend/src/store/toast.rs#L52-L73)
- 仪表盘绘制异常或模糊
  - 检查 width/height 与 devicePixelRatio 设置；确认 ctx 获取成功。
  - 参考路径：[gauge.rs:82-135](file://frontend/src/components/gauge.rs#L82-L135)
- 样式未生效
  - 确认 Tailwind 已编译 output.css；检查 input.css 中的 @source 与主题配置。
  - 参考路径：[styles/input.css:1-45](file://frontend/styles/input.css#L1-L45)、[package.json:4-11](file://frontend/package.json#L4-L11)

章节来源
- [frontend/src/components/modal.rs:15-43](file://frontend/src/components/modal.rs#L15-L43)
- [frontend/src/components/toast.rs:27-93](file://frontend/src/components/toast.rs#L27-L93)
- [frontend/src/store/toast.rs:52-73](file://frontend/src/store/toast.rs#L52-L73)
- [frontend/src/components/gauge.rs:82-135](file://frontend/src/components/gauge.rs#L82-L135)
- [frontend/styles/input.css:1-45](file://frontend/styles/input.css#L1-L45)
...
## 附录
- 使用示例参考路径
  - 按钮：[button.rs:15-49](file://frontend/src/components/button.rs#L15-L49)
  - 模态框：[modal.rs:5-43](file://frontend/src/components/modal.rs#L5-L43)
  - 确认对话框：[confirm_dialog.rs:60-97](file://frontend/src/components/confirm_dialog.rs#L60-L97)
  - Toast 全局容器：[toast.rs:7-25](file://frontend/src/components/toast.rs#L7-L25)
  - Toast 状态 API：[store/toast.rs:43-95](file://frontend/src/store/toast.rs#L43-L95)
  - 仪表盘：[gauge.rs:67-159](file://frontend/src/components/gauge.rs#L67-L159)
  - AOP 仪表盘：[aop_gauge.rs:57-87](file://frontend/src/components/aop_gauge.rs#L57-L87)
  - 统计面板：[stats.rs:89-261](file://frontend/src/components/stats.rs#L89-L261)
