...
- [统计图表Phase1基础设施与时序图展示重构.md](docs/plan/统计图表Phase1基础设施与时序图展示重构.md) — StatsPanel / LineChart / DonutChart / Gauge 4 个 charts/ Layer4 复合业务组件
- [知识图谱推荐起点与组件复用重构.md](docs/plan/知识图谱推荐起点与组件复用重构.md) — KnowledgeGraph Layer3 复合业务组件（两端复用：路由页 + Agent 详情页 Tab）
