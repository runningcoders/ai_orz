...
- [message_channel.rs（枚举）](common/src/enums/message_channel.rs)
- [message_channel.rs（模型）](src/models/message_channel.rs)
- [message_channel.rs（DAL）](src/service/dal/message_channel.rs)
- [message_channel.rs（DAO 模块入口）](src/service/dao/message_channel/mod.rs)
- [webhook DAO](src/service/dao/webhook/mod.rs)
- [lark DAO](src/service/dao/lark/mod.rs)
- [wechat DAO](src/service/dao/wechat/mod.rs)
- [slack DAO](src/service/dao/slack/mod.rs)
- [email DAO](src/service/dao/email/mod.rs)
- [a2a_callback DAO](src/service/dao/a2a_callback/mod.rs)
- [message_channel API DTO](common/src/api/message_channel.rs)
- [message_channel 处理器模块](src/handlers/finance/message_channel/mod.rs)
- [message_consumer.rs](src/consumer/message.rs)
- [message_delivery_test.rs](tests/integration/message_delivery_test.rs)
</cite>
...
> 本长文是「消息渠道管理」主题的 **前端 UI 层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [消息渠道管理（业务功能层）](docs/wiki/zh/content/功能模块/消息系统/消息渠道管理.md)
...
图表来源
- [message_channel.rs（DAL）:62-126](src/service/dal/message_channel.rs#L62-L126)
- [message_channel.rs（DAL）:202-284](src/service/dal/message_channel.rs#L202-L284)
- [message_channel_design.md:424-474](docs/message_channel_design.md#L424-L474)

章节来源
- [message_channel_design.md:74-159](docs/message_channel_design.md#L74-L159)
- [message_channel.rs（DAL）:1-126](src/service/dal/message_channel.rs#L1-L126)
...
章节来源
- [message_channel.rs（枚举）:9-122](common/src/enums/message_channel.rs#L9-L122)
- [message_channel.rs（模型）:19-255](src/models/message_channel.rs#L19-L255)
- [message_channel.rs（DAL）:62-126](src/service/dal/message_channel.rs#L62-L126)
- [message_channel.rs（DAL）:226-284](src/service/dal/message_channel.rs#L226-L284)
- [message_channel.rs（DAL）:340-406](src/service/dal/message_channel.rs#L340-L406)
- [message_channel API DTO:9-315](common/src/api/message_channel.rs#L9-L315)
- [message_channel 处理器模块:1-22](src/handlers/finance/message_channel/mod.rs#L1-L22)
- [message_consumer.rs:64-141](src/consumer/message.rs#L64-L141)
- [message_consumer.rs:359-389](src/consumer/message.rs#L359-L389)
...
图表来源
- [message_consumer.rs:78-128](src/consumer/message.rs#L78-L128)
- [message_consumer.rs:359-389](src/consumer/message.rs#L359-L389)
- [message_channel.rs（DAL）:226-284](src/service/dal/message_channel.rs#L226-L284)
...
章节来源
- [message_channel.rs（枚举）:9-122](common/src/enums/message_channel.rs#L9-L122)
- [message_channel.rs（模型）:67-107](src/models/message_channel.rs#L67-L107)
...
章节来源
- [message_channel.rs（模型）:115-255](src/models/message_channel.rs#L115-L255)
...
图表来源
- [message_channel.rs（DAL）:226-284](src/service/dal/message_channel.rs#L226-L284)
- [message_channel.rs（DAL）:289-335](src/service/dal/message_channel.rs#L289-L335)
...
章节来源
- [message_channel.rs（DAL）:202-222](src/service/dal/message_channel.rs#L202-L222)
...
章节来源
- [message_channel_design.md:155-159](docs/message_channel_design.md#L155-L159)
- [message_channel.rs（模型）:245-255](src/models/message_channel.rs#L245-L255)
...
章节来源
- [message_channel.rs（DAL）:315-335](src/service/dal/message_channel.rs#L315-L335)
- [message_channel.rs（DAL）:340-406](src/service/dal/message_channel.rs#L340-L406)
...
章节来源
- [message_channel.rs（模型）:121-146](src/models/message_channel.rs#L121-L146)
- [message_channel.rs（DAL）:243-256](src/service/dal/message_channel.rs#L243-L256)
...
图表来源
- [message_channel.rs（DAL）:62-142](src/service/dal/message_channel.rs#L62-L142)
- [message_channel.rs（DAL）:289-313](src/service/dal/message_channel.rs#L289-L313)
...
章节来源
- [message_channel_design.md:23-36](docs/message_channel_design.md#L23-L36)
- [message_delivery_test.rs:653-730](tests/integration/message_delivery_test.rs#L653-L730)
- [message_delivery_test.rs:517-651](tests/integration/message_delivery_test.rs#L517-L651)
...
章节来源
- [message_channel.rs（模型）:197-255](src/models/message_channel.rs#L197-L255)
- [message_channel_design.md:194-231](docs/message_channel_design.md#L194-L231)