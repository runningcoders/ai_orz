...
**章节来源**
- [frontend/src/components/graph.rs](frontend/src/components/graph.rs)（矩形卡片几何 SSOT）
- [frontend/src/components/graph_canvas.rs](frontend/src/components/graph_canvas.rs)（Canvas 矩形渲染）
