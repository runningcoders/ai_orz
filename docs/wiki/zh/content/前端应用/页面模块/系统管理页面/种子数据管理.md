...
<cite>
**本文引用的文件**
- [docs/archive/design-archive/seed-config-migration.md](docs/archive/design-archive/seed-config-migration.md)
...
- [frontend/src/pages/system/seed.rs](frontend/src/pages/system/seed.rs)
</cite>
...
> 本长文是「种子数据管理」主题的 **前端 UI 层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [种子数据管理（业务功能层）](docs/wiki/zh/content/功能模块/系统管理/种子数据管理.md)
...
图表来源
- [frontend/src/pages/system/seed.rs:1-35](frontend/src/pages/system/seed.rs#L1-L35)
- [src/handlers/system/seed/mod.rs:1-30](src/handlers/system/seed/mod.rs#L1-L30)
- [src/service/domain/system/seed/mod.rs:1-16](src/service/domain/system/seed/mod.rs#L1-L16)
- [src/service/domain/system/seed/defs.rs:1-42](src/service/domain/system/seed/defs.rs#L1-L42)
- [src/service/domain/system/seed/diff.rs:1-38](src/service/domain/system/seed/diff.rs#L1-L38)
- [src/service/domain/system/seed/store.rs:1-27](src/service/domain/system/seed/store.rs#L1-L27)
...
章节来源
- [docs/archive/design-archive/seed-config-migration.md:1-85](docs/archive/design-archive/seed-config-migration.md#L1-L85)
- [src/service/domain/system/seed/mod.rs:1-16](src/service/domain/system/seed/mod.rs#L1-L16)
...
章节来源
- [common/src/api/seed.rs:1-163](common/src/api/seed.rs#L1-L163)
- [src/service/domain/system/seed/defs.rs:1-224](src/service/domain/system/seed/defs.rs#L1-L224)
- [src/service/domain/system/seed/diff.rs:1-255](src/service/domain/system/seed/diff.rs#L1-L255)
- [src/service/domain/system/seed/store.rs:1-118](src/service/domain/system/seed/store.rs#L1-L118)
- [src/service/domain/system/seed/default.rs:1-11](src/service/domain/system/seed/default.rs#L1-L11)
...
- [src/service/domain/system/seed/store.rs:92-104](src/service/domain/system/seed/store.rs#L92-L104)

章节来源
- [docs/archive/design-archive/seed-config-migration.md:11-26](docs/archive/design-archive/seed-config-migration.md#L11-L26)
- [src/handlers/system/seed/mod.rs:1-10](src/handlers/system/seed/mod.rs#L1-L10)
...
- [src/service/domain/system/seed/store.rs:77-104](src/service/domain/system/seed/store.rs#L77-L104)
- [src/service/domain/system/seed/diff.rs:171-201](src/service/domain/system/seed/diff.rs#L171-L201)

章节来源
- [src/handlers/system/seed/save.rs:123-171](src/handlers/system/seed/save.rs#L123-L171)
- [src/handlers/system/seed/load.rs:124-162](src/handlers/system/seed/load.rs#L124-L162)
- [src/handlers/system/seed/get_default.rs:1-16](src/handlers/system/seed/get_default.rs#L1-L16)
...
图表来源
- [src/handlers/system/seed/diff.rs:15-31](src/handlers/system/seed/diff.rs#L15-L31)
...
- [src/handlers/system/seed/mod.rs:411-480](src/handlers/system/seed/mod.rs#L411-L480)
- [src/service/domain/system/seed/defs.rs:16-42](src/service/domain/system/seed/defs.rs#L16-L42)
...
- [src/handlers/system/seed/load.rs:152-162](src/handlers/system/seed/load.rs#L152-L162)
- [src/handlers/system/seed/save.rs:161-171](src/handlers/system/seed/save.rs#L161-L171)
- [src/handlers/system/seed/apply_default.rs:1-69](src/handlers/system/seed/apply_default.rs#L1-L69)
...
章节来源
- [docs/archive/design-archive/seed-config-migration.md:51-56](docs/archive/design-archive/seed-config-migration.md#L51-L56)
- [src/handlers/system/seed/mod.rs:443-480](src/handlers/system/seed/mod.rs#L443-L480)
...
章节来源
- [src/handlers/system/seed/save.rs:17-78](src/handlers/system/seed/save.rs#L17-L78)
- [src/handlers/system/seed/load.rs:17-79](src/handlers/system/seed/load.rs#L17-L79)
...
- [src/service/domain/system/seed/store.rs:77-104](src/service/domain/system/seed/store.rs#L77-L104)
- [src/handlers/system/seed/mod.rs:36-46](src/handlers/system/seed/mod.rs#L36-L46)
- [src/handlers/system/seed/mod.rs:124-128](src/handlers/system/seed/mod.rs#L124-L128)
...
章节来源
- [src/service/domain/system/seed/defs.rs:16-224](src/service/domain/system/seed/defs.rs#L16-L224)
- [src/handlers/system/seed/get_default.rs:1-16](src/handlers/system/seed/get_default.rs#L1-L16)
- [frontend/src/pages/system/seed.rs:1-35](frontend/src/pages/system/seed.rs#L1-L35)