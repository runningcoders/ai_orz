...
<cite>
**本文引用的文件**
- [docs/design/seed-config-migration.md](docs/design/seed-config-migration.md)
...
章节来源
- [docs/design/seed-config-migration.md:1-85](docs/design/seed-config-migration.md#L1-L85)
- [src/service/domain/system/seed/mod.rs:1-16](src/service/domain/system/seed/mod.rs#L1-L16)
...
章节来源
- [docs/design/seed-config-migration.md:11-26](docs/design/seed-config-migration.md#L11-L26)
...
章节来源
- [docs/design/seed-config-migration.md:51-56](docs/design/seed-config-migration.md#L51-L56)
