...
- [artifact.rs（DAL 层）](src/service/dal/artifact.rs)
- [mod.rs（处理器聚合）](src/handlers/project/artifact/mod.rs)
- [list_artifacts.rs](src/handlers/project/artifact/list_artifacts.rs)
- [get_artifact_content.rs](src/handlers/project/artifact/get_artifact_content.rs)
...
- [register_artifact_from_path.rs](src/handlers/project/artifact/register_artifact_from_path.rs)
- [artifact.rs（枚举：来源类型）](common/src/enums/artifact.rs)
- [file.rs（枚举：文件类型）](common/src/enums/file.rs)
</cite>
...
图表来源
- [mod.rs（处理器聚合）:1-24](src/handlers/project/artifact/mod.rs#L1-L24)
- [artifact.rs（领域层）:26-192](src/service/domain/project/artifact.rs#L26-L192)
- [artifact.rs（DAL 层）:36-91](src/service/dal/artifact.rs#L36-L91)
...
- [artifact.rs（枚举：来源类型）:8-62](common/src/enums/artifact.rs#L8-L62)
- [file.rs（枚举：文件类型）:11-56](common/src/enums/file.rs#L11-L56)
- [artifact.rs（领域层）:26-487](src/service/domain/project/artifact.rs#L26-L487)
- [artifact.rs（DAL 层）:36-195](src/service/dal/artifact.rs#L36-L195)
- [create_artifact.rs:13-146](src/handlers/project/artifact/create_artifact.rs#L13-L146)
- [list_artifacts.rs:12-52](src/handlers/project/artifact/list_artifacts.rs#L12-L52)
- [get_artifact_content.rs:11-68](src/handlers/project/artifact/get_artifact_content.rs#L11-L68)
- [update_artifact.rs:9-54](src/handlers/project/artifact/update_artifact.rs#L9-L54)
- [register_artifact_from_path.rs:11-108](src/handlers/project/artifact/register_artifact_from_path.rs#L11-L108)
...
图表来源
- [create_artifact.rs:22-146](src/handlers/project/artifact/create_artifact.rs#L22-L146)
- [artifact.rs（领域层）:342-399](src/service/domain/project/artifact.rs#L342-L399)
- [artifact.rs（DAL 层）:101-105](src/service/dal/artifact.rs#L101-L105)
...
图表来源
- [list_artifacts.rs:20-52](src/handlers/project/artifact/list_artifacts.rs#L20-L52)
- [artifact.rs（领域层）:167-192](src/service/domain/project/artifact.rs#L167-L192)
...
图表来源
- [get_artifact_content.rs:19-68](src/handlers/project/artifact/get_artifact_content.rs#L19-L68)
- [artifact.rs（领域层）:224-271](src/service/domain/project/artifact.rs#L224-L271)
- [artifact.rs（DAL 层）:176-194](src/service/dal/artifact.rs#L176-L194)
...
图表来源
- [create_artifact.rs:22-146](src/handlers/project/artifact/create_artifact.rs#L22-L146)
- [artifact.rs（领域层）:28-125](src/service/domain/project/artifact.rs#L28-L125)
- [artifact.rs（领域层）:342-399](src/service/domain/project/artifact.rs#L342-L399)
- [register_artifact_from_path.rs:23-108](src/handlers/project/artifact/register_artifact_from_path.rs#L23-L108)
...
图表来源
- [update_artifact.rs:21-54](src/handlers/project/artifact/update_artifact.rs#L21-L54)
- [artifact.rs（领域层）:273-340](src/service/domain/project/artifact.rs#L273-L340)
- [artifact.rs（DAL 层）:171-174](src/service/dal/artifact.rs#L171-L174)
...
- [artifact.rs（枚举：来源类型）:8-62](common/src/enums/artifact.rs#L8-L62)
- [file.rs（枚举：文件类型）:11-56](common/src/enums/file.rs#L11-L56)
- [register_artifact_from_path.rs:78-88](src/handlers/project/artifact/register_artifact_from_path.rs#L78-L88)
...
- [register_artifact_from_path.rs:48-65](src/handlers/project/artifact/register_artifact_from_path.rs#L48-L65)
...
- [get_artifact_content.rs:19-68](src/handlers/project/artifact/get_artifact_content.rs#L19-L68)
- [update_artifact.rs:21-54](src/handlers/project/artifact/update_artifact.rs#L21-L54)
- [artifact.rs（领域层）:224-340](src/service/domain/project/artifact.rs#L224-L340)
- [register_artifact_from_path.rs:23-108](src/handlers/project/artifact/register_artifact_from_path.rs#L23-L108)
