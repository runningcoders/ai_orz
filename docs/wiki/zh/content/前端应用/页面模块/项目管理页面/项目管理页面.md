...
- [项目详情页面](file://frontend/src/pages/project/project_detail.rs)
- [任务详情页面](file://frontend/src/pages/project/task_detail.rs)
- [Markdown渲染组件](file://frontend/src/components/markdown.rs)
- [项目API响应定义](file://common/src/api/project.rs)
- [任务API响应定义](file://common/src/api/task.rs)
- [项目处理器响应映射](file://src/handlers/project/projects/response.rs)
- [任务处理器响应映射](file://src/handlers/project/task/response.rs)
</cite>
...
- [Markdown渲染组件:1-210](file://frontend/src/components/markdown.rs#L1-L210)
...
- [项目详情页面:404-451](file://frontend/src/pages/project/project_detail.rs#L404-L451)
...
- [任务业务实现:394-482](file://src/service/domain/project/task.rs#L394-L482)
- [项目API响应定义:54-63](file://common/src/api/project.rs#L54-L63)
- [项目详情页面:443-451](file://frontend/src/pages/project/project_detail.rs#L443-L451)
...
- [Markdown渲染组件:1-210](file://frontend/src/components/markdown.rs#L1-L210)
- [项目详情页面:404-451](file://frontend/src/pages/project/project_detail.rs#L404-L451)
- [任务详情页面:464-487](file://frontend/src/pages/project/task_detail.rs#L464-L487)
- [前端index.html:421-477](file://frontend/index.html#L421-L477)
...
- [Markdown渲染组件:66-67](file://frontend/src/components/markdown.rs#L66-L67)
...
- [项目处理器响应映射:20-45](file://src/handlers/project/projects/response.rs#L20-L45)
- [任务处理器响应映射:25-53](file://src/handlers/project/task/response.rs#L25-L53)
