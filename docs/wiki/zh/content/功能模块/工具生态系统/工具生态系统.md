...
- 【① Design 决策】[docs/design/tool_design.md](docs/design/tool_design.md) — 工具系统三层调用架构 + 工具包 tag 免绑定三层校验 + register_handler_tool 宏
- 【① Design 决策】[docs/design/mcp_tool_design.md](docs/design/mcp_tool_design.md) — MCP Server 注册表 + descriptor 缓存 + run_mcp 调用桥
- 【② Plan 落地】[docs/plan/进程管理与shell_exec修复.md](docs/plan/进程管理与shell_exec修复.md) — shell_exec 命令黑白名单 + fs 路径安全双校验
- 【② Plan 落地】[docs/plan/前端工具与进程管理.md](docs/plan/前端工具与进程管理.md) — 前端工具管理 Builtin/HTTP/MCP 三 Tab 页面
