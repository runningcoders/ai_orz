...
- **2026-09-05 更新摘要**：JWT Claims R2/R3 扩展 iss/aud；RequestContext 新增 caller_organization_id；/a2a 入口新增双模鉴权中间件。
</cite>
...
- [src/middleware/jwt_auth.rs:25-87](src/middleware/jwt_auth.rs#L25-L87)
- [src/pkg/request_context.rs:23-61](src/pkg/request_context.rs#L23-L61)
...
- [src/handlers/organization/auth/logout.rs:15-40](src/handlers/organization/auth/logout.rs#L15-L40)
- [src/service/domain/organization/user.rs:85-123](src/service/domain/organization/user.rs#L85-L123)
...
章节来源
- [src/middleware/jwt_auth.rs:25-156](src/middleware/jwt_auth.rs#L25-L156)
...
- [src/middleware/require_role.rs:16-39](src/middleware/require_role.rs#L16-L39)
...
- [src/middleware/require_role.rs:1-39](src/middleware/require_role.rs#L1-L39)
- [src/pkg/jwt.rs:1-136](src/pkg/jwt.rs#L1-L136)
- [common/src/constants/http_header.rs:1-20](common/src/constants/http_header.rs#L1-L20)
- [common/src/enums/user.rs:1-100](common/src/enums/user.rs#L1-L100)
- [src/pkg/request_context.rs:295-356](src/pkg/request_context.rs#L295-L356)
- [src/handlers/organization/auth/login.rs:18-69](src/handlers/organization/auth/login.rs#L18-L69)
- [src/service/domain/organization/user.rs:85-123](src/service/domain/organization/user.rs#L85-L123)
...
- [src/middleware/require_role.rs:20-39](src/middleware/require_role.rs#L20-L39)
- [src/service/domain/organization/user.rs:85-123](src/service/domain/organization/user.rs#L85-L123)
- [src/pkg/request_context.rs:295-356](src/pkg/request_context.rs#L295-L356)
...
章节来源
- [common/src/api/auth.rs:29-39](common/src/api/auth.rs#L29-L39)
- [src/handlers/organization/auth/logout.rs:15-40](src/handlers/organization/auth/logout.rs#L15-L40)
...
- [src/service/domain/organization/user.rs:85-123](src/service/domain/organization/user.rs#L85-L123)
- [src/pkg/jwt.rs:11-106](src/pkg/jwt.rs#L11-L106)
- [src/router.rs:110-116](src/router.rs#L110-L116)