...
- [进程详情采用共享组件 + Modal 弹窗，不新建独立路由页](docs/wiki/knowledge/zh/进程详情采用共享组件 + Modal 弹窗，不新建独立路由页/进程详情采用共享组件 + Modal 弹窗，不新建独立路由页.md)
- [进程列表通过 shell_list LLM 工具双暴露，复用 Agent scope 过滤](docs/wiki/knowledge/zh/进程列表通过 shell_list LLM 工具双暴露，复用 Agent scope 过滤/进程列表通过 shell_list LLM 工具双暴露，复用 Agent scope 过滤.md)
</cite>
...
**图表来源**
- [src/router.rs:809-824](src/router.rs#L809-L824)
- [src/handlers/system/process/shell_list.rs:10-49](src/handlers/system/process/shell_list.rs#L10-L49)
- [src/service/domain/system/mod.rs:114-125](src/service/domain/system/mod.rs#L114-L125)
- [src/service/domain/system/process.rs:37-89](src/service/domain/system/process.rs#L37-L89)
- [src/pkg/process/mod.rs:57-124](src/pkg/process/mod.rs#L57-L124)
- [src/pkg/request_context.rs:22-65](src/pkg/request_context.rs#L22-L65)
...
**章节来源**
- [src/pkg/process/mod.rs:15-124](src/pkg/process/mod.rs#L15-L124)
- [src/service/domain/system/process.rs:13-89](src/service/domain/system/process.rs#L13-L89)
- [src/handlers/system/process/shell_list.rs:10-49](src/handlers/system/process/shell_list.rs#L10-L49)
- [common/src/api/system.rs:240-328](common/src/api/system.rs#L240-L328)
- [frontend/src/pages/system/processes.rs:33-203](frontend/src/pages/system/processes.rs#L33-L203)
- [frontend/src/components/process_detail.rs:28-156](frontend/src/components/process_detail.rs#L28-L156)
- [frontend/src/components/chat/tool_calls_tab.rs:78-293](frontend/src/components/chat/tool_calls_tab.rs#L78-L293)
- [frontend/src/components/create_http_tool.rs:144-200](frontend/src/components/create_http_tool.rs#L144-L200)
...
- [src/service/domain/system/mod.rs:114-125](src/service/domain/system/mod.rs#L114-L125)
- [src/service/domain/system/process.rs:46-56](src/service/domain/system/process.rs#L46-L56)
- [src/pkg/process/mod.rs:86-118](src/pkg/process/mod.rs#L86-L118)
...
**图表来源**
- [src/pkg/process/mod.rs:103-118](src/pkg/process/mod.rs#L103-L118)
- [src/pkg/process/mod.rs:138-174](src/pkg/process/mod.rs#L138-L174)

**章节来源**
- [src/pkg/process/mod.rs:15-174](src/pkg/process/mod.rs#L15-L174)
...
**图表来源**
- [src/service/domain/system/mod.rs:224-249](src/service/domain/system/mod.rs#L224-L249)
- [src/service/domain/system/process.rs:20-89](src/service/domain/system/process.rs#L20-L89)
- [src/pkg/process/mod.rs:24-55](src/pkg/process/mod.rs#L24-L55)
...
- [frontend/src/components/chat/tool_calls_tab.rs:200-275](frontend/src/components/chat/tool_calls_tab.rs#L200-L275)
...
**章节来源**
- [frontend/src/components/create_http_tool.rs:1-200](frontend/src/components/create_http_tool.rs#L1-200)
...
**图表来源**
- [src/pkg/tool_registry/shell_exec.rs:1-34](src/pkg/tool_registry/shell_exec.rs#L1-L34)
- [src/pkg/request_context.rs:22-65](src/pkg/request_context.rs#L22-L65)
- [src/pkg/process/mod.rs:24-55](src/pkg/process/mod.rs#L24-L55)
...
**章节来源**
- [src/service/domain/system/process.rs:20-31](src/service/domain/system/process.rs#L20-L31)
- [src/pkg/process/mod.rs:156-174](src/pkg/process/mod.rs#L156-L174)
- [src/pkg/process/mod.rs:126-134](src/pkg/process/mod.rs#L126-L134)
- [src/router.rs:809-824](src/router.rs#L809-L824)
