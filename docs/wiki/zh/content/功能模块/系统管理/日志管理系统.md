...
<cite>
**本文引用的文件**
- [logging_design.md](docs/design/logging_design.md)
- [logging.rs](src/pkg/logging.rs)
- [log_fields.rs](ai-orz-macros/src/log_fields.rs)
- [query_logs.rs](src/handlers/system/logs/query_logs.rs)
- [log_stats.rs](src/handlers/system/logs/log_stats.rs)
- [log_query.rs](src/service/dal/log_query.rs)
- [log_stats.rs(common api)](common/src/api/log_stats.rs)
- [logs.rs(frontend)](frontend/src/pages/system/logs.rs)
</cite>
...
> 本长文是「日志管理系统」主题的 **系统管理层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [日志管理系统（前端 UI 层）](docs/wiki/zh/content/前端应用/页面模块/系统管理页面/日志管理系统.md)
> - [日志管理系统（入门概览层）](docs/wiki/zh/content/项目概述/核心功能特性/系统管理功能/日志管理系统.md)
...
**图示来源**
- [logging.rs:29-124](src/pkg/logging.rs#L29-L124)
- [log_query.rs:120-210](src/service/dal/log_query.rs#L120-L210)
- [query_logs.rs:13-28](src/handlers/system/logs/query_logs.rs#L13-L28)
- [log_stats.rs:25-76](src/handlers/system/logs/log_stats.rs#L25-L76)
- [log_fields.rs:50-125](ai-orz-macros/src/log_fields.rs#L50-L125)
...
**章节来源**
- [logging.rs:29-124](src/pkg/logging.rs#L29-L124)
- [log_query.rs:34-82](src/service/dal/log_query.rs#L34-L82)
- [log_query.rs:120-210](src/service/dal/log_query.rs#L120-L210)
- [log_query.rs:263-361](src/service/dal/log_query.rs#L263-L361)
- [query_logs.rs:13-28](src/handlers/system/logs/query_logs.rs#L13-L28)
- [log_stats.rs:25-76](src/handlers/system/logs/log_stats.rs#L25-L76)
- [log_fields.rs:50-125](ai-orz-macros/src/log_fields.rs#L50-L125)
- [logs.rs(frontend):1-33](frontend/src/pages/system/logs.rs#L1-L33)
...
**图示来源**
- [logging.rs:29-124](src/pkg/logging.rs#L29-L124)
- [logging.rs:126-158](src/pkg/logging.rs#L126-L158)
...
- [query_logs.rs:13-28](src/handlers/system/logs/query_logs.rs#L13-L28)
- [log_stats.rs:25-76](src/handlers/system/logs/log_stats.rs#L25-L76)
- [log_stats.rs(common api):7-77](common/src/api/log_stats.rs#L7-L77)
- [logs.rs(frontend):1-33](frontend/src/pages/system/logs.rs#L1-L33)
...
- [logging.rs:29-124](src/pkg/logging.rs#L29-L124)
- [logging.rs:126-158](src/pkg/logging.rs#L126-L158)
- [log_query.rs:112-118](src/service/dal/log_query.rs#L112-L118)
...
**章节来源**
- [query_logs.rs:1-4](src/handlers/system/logs/query_logs.rs#L1-L4)
- [logging_design.md:106-127](docs/design/logging_design.md#L106-L127)
...
**章节来源**
- [logging_design.md:63-127](docs/design/logging_design.md#L63-L127)
- [log_query.rs:263-361](src/service/dal/log_query.rs#L263-L361)
...
**章节来源**
- [log_query.rs:112-118](src/service/dal/log_query.rs#L112-L118)
- [log_query.rs:147-194](src/service/dal/log_query.rs#L147-L194)
- [log_query.rs:330-361](src/service/dal/log_query.rs#L330-L361)
...
**章节来源**
- [log_query.rs:132-141](src/service/dal/log_query.rs#L132-L141)
- [log_query.rs:330-361](src/service/dal/log_query.rs#L330-L361)
- [logging.rs:36-50](src/pkg/logging.rs#L36-L50)
