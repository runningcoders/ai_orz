...
- [src/pkg/aop/core/consumer.rs:15-72](file://src/pkg/aop/core/consumer.rs#L15-L72)
- [src/pkg/aop/core/producer.rs:7-36](file://src/pkg/aop/core/producer.rs#L7-L36)
...
图表来源
- [src/pkg/aop/queue/in_memory.rs:104-267](file://src/pkg/aop/queue/in_memory.rs#L104-L267)
- [src/pkg/aop/core/registry.rs:318-445](file://src/pkg/aop/core/registry.rs#L318-L445)
...
- 注册消费者
  ...
  - 参考路径：[src/pkg/aop/core/consumer.rs:15-72](file://src/pkg/aop/core/consumer.rs#L15-L72)
- 发布事件
  - 使用 aop::publish 便捷方法，或通过 Registry.publish。
  - 参考路径：[src/pkg/aop/mod.rs:48-51](file://src/pkg/aop/mod.rs#L48-L51)
- 启动调度器
  - 调用 aop::init_all 启动所有异步消费者 worker 与生产者轮询。
  - 参考路径：[src/pkg/aop/mod.rs:53-60](file://src/pkg/aop/mod.rs#L53-L60)
- 队列配置与监控
  - 通过 Consumer 配置 concurrency、empty_queue_sleep_ms、error_retry_sleep_ms。
  - 使用 queue_stats/query_events/get_event 进行监控与排障。
  - 参考路径：[src/pkg/aop/core/consumer.rs:57-70](file://src/pkg/aop/core/consumer.rs#L57-L70)、[src/pkg/aop/core/registry.rs:500-553](file://src/pkg/aop/core/registry.rs#L500-L553)
- 生产者集成
  - 实现 Producer 接口，选择轮询或非轮询模式，由 Registry 统一管理。
  - 参考路径：[src/pkg/aop/core/producer.rs:7-36](file://src/pkg/aop/core/producer.rs#L7-L36)
