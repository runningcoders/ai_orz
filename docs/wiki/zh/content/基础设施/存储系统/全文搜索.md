...
- [sqlite.rs（Task DAO）](src/service/dao/task/sqlite.rs)
- [sqlite.rs（Tool DAO）](src/service/dao/tool/sqlite.rs)
- [sqlite.rs（Agent DAO）](src/service/dao/agent/sqlite.rs)
- [mod.rs（Skill DAO）](src/service/dao/skill/mod.rs)
- [mod.rs（Project DAO）](src/service/dao/project/mod.rs)
...
> 本长文是「全文搜索」主题的 **框架层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [全文搜索（代码落地层）](docs/wiki/zh/content/核心模块/存储系统/全文搜索.md)
...
图表来源
- [task.rs:143-153](src/service/dal/task.rs#L143-L153)
- [sqlite.rs（Task DAO）:177-200](src/service/dao/task/sqlite.rs#L177-L200)
- [sqlite.rs（Tool DAO）:429-453](src/service/dao/tool/sqlite.rs#L429-L453)
- [sqlite.rs（Agent DAO）:141-230](src/service/dao/agent/sqlite.rs#L141-L230)
- [mod.rs（Skill DAO）:101-109](src/service/dao/skill/mod.rs#L101-L109)
- [mod.rs（Project DAO）:97-110](src/service/dao/project/mod.rs#L97-L110)
...
章节来源
- [20260712000000_memory_fts5.sql:16-29](migrations/20260712000000_memory_fts5.sql#L16-L29)
...
章节来源
- [20260712000000_memory_fts5.sql:16-29](migrations/20260712000000_memory_fts5.sql#L16-L29)
- [20260712000000_memory_fts5.sql:35-79](migrations/20260712000000_memory_fts5.sql#L35-L79)
- [20260712000000_memory_fts5.sql:85-92](migrations/20260712000000_memory_fts5.sql#L85-L92)
- [20260712000001_entity_fts5.sql:18-66](migrations/20260712000001_entity_fts5.sql#L18-L66)
- [20260712000001_entity_fts5.sql:72-217](migrations/20260712000001_entity_fts5.sql#L72-L217)
- [20260712000001_entity_fts5.sql:223-246](migrations/20260712000001_entity_fts5.sql#L223-L246)
...
章节来源
- [fts5.rs:6-18](src/pkg/storage/fts5.rs#L6-L18)
- [sqlite.rs（Task DAO）:184-193](src/service/dao/task/sqlite.rs#L184-L193)
- [sqlite.rs（Agent DAO）:148-156](src/service/dao/agent/sqlite.rs#L148-L156)
...
章节来源
- [sqlite.rs（Task DAO）:195-200](src/service/dao/task/sqlite.rs#L195-L200)
- [sqlite.rs（Tool DAO）:429-453](src/service/dao/tool/sqlite.rs#L429-L453)
...
- [20260712000000_memory_fts5.sql:35-79](migrations/20260712000000_memory_fts5.sql#L35-L79)
- [20260712000001_entity_fts5.sql:72-217](migrations/20260712000001_entity_fts5.sql#L72-L217)
- [sqlite.rs（Task DAO）:184-200](src/service/dao/task/sqlite.rs#L184-L200)
- [sqlite.rs（Tool DAO）:429-453](src/service/dao/tool/sqlite.rs#L429-L453)
- [sqlite.rs（Agent DAO）:148-230](src/service/dao/agent/sqlite.rs#L148-L230)
- [task.rs:405-437](src/service/dal/task.rs#L405-L437)
- [ai_orz.toml:14-29](common/config/ai_orz.toml#L14-L29)
