...
> 本长文是「向量存储」主题的 **框架层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [向量存储（代码落地层）](docs/wiki/zh/content/核心模块/存储系统/向量存储/向量存储.md)
...
- [src/pkg/storage/hnsw.rs:149-166](src/pkg/storage/hnsw.rs#L149-L166)
- [src/pkg/storage/lance.rs:26-33](src/pkg/storage/lance.rs#L26-L33)
- [src/pkg/storage/vector.rs:76-81](src/pkg/storage/vector.rs#L76-L81)
...
- [src/pkg/storage/mem_vector.rs:121-186](src/pkg/storage/mem_vector.rs#L121-L186)
- [src/pkg/storage/mem_vector.rs:188-228](src/pkg/storage/mem_vector.rs#L188-L228)
- [src/pkg/storage/mem_vector.rs:236-274](src/pkg/storage/mem_vector.rs#L236-L274)
...
- [src/pkg/storage/hnsw.rs:36-62](src/pkg/storage/hnsw.rs#L36-L62)
- [src/pkg/storage/hnsw.rs:96-125](src/pkg/storage/hnsw.rs#L96-L125)
- [src/pkg/storage/hnsw.rs:149-166](src/pkg/storage/hnsw.rs#L149-L166)
- [src/pkg/storage/hnsw.rs:189-219](src/pkg/storage/hnsw.rs#L189-L219)
- [src/pkg/storage/hnsw.rs:344-388](src/pkg/storage/hnsw.rs#L344-L388)
- [src/pkg/storage/hnsw.rs:432-491](src/pkg/storage/hnsw.rs#L432-L491)
- [src/pkg/storage/hnsw.rs:493-543](src/pkg/storage/hnsw.rs#L493-L543)
- [src/pkg/storage/hnsw.rs:556-616](src/pkg/storage/hnsw.rs#L556-L616)
...
- [src/pkg/storage/lance.rs:126-199](src/pkg/storage/lance.rs#L126-L199)
...
- [src/pkg/storage/vector.rs:237-290](src/pkg/storage/vector.rs#L237-L290)
...
章节来源
- [src/pkg/storage/mem_vector.rs:103-117](src/pkg/storage/mem_vector.rs#L103-L117)
- [src/pkg/storage/hnsw.rs:107-125](src/pkg/storage/hnsw.rs#L107-L125)
- [src/pkg/storage/hnsw.rs:344-388](src/pkg/storage/hnsw.rs#L344-L388)
- [src/pkg/storage/vector.rs:126-173](src/pkg/storage/vector.rs#L126-L173)
- [src/pkg/storage/lance.rs:201-282](src/pkg/storage/lance.rs#L201-L282)
