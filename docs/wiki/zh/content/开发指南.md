...
- [ai-orz-macros/Cargo.toml](file://ai-orz-macros/Cargo.toml)
- [AGENTS.md](file://AGENTS.md)
- [docs/ARCHITECTURE.md](file://docs/ARCHITECTURE.md)
- [docs/CODE_WIKI.md](file://docs/CODE_WIKI.md)
...
**图示来源**
- [docs/ARCHITECTURE.md:11-46](file://docs/ARCHITECTURE.md#L11-L46)
- [docs/CODE_WIKI.md:91-128](file://docs/CODE_WIKI.md#L91-L128)
...
- [start.sh:1-12](file://start.sh#L1-L12)
...
**图示来源**
- [docs/ARCHITECTURE.md:130-163](file://docs/ARCHITECTURE.md#L130-L163)
- [docs/CODE_WIKI.md:130-164](file://docs/CODE_WIKI.md#L130-L164)
...
**图示来源**
- [start.sh:66-188](file://start.sh#L66-L188)
...
- [AGENTS.md:257-298](file://AGENTS.md#L257-L298)
- [AGENTS.md:299-393](file://AGENTS.md#L299-L393)
- [AGENTS.md:422-438](file://AGENTS.md#L422-L438)
- [AGENTS.md:439-445](file://AGENTS.md#L439-L445)
...
- [AGENTS.md:758-800](file://AGENTS.md#L758-L800)
...
- [docs/CODE_WIKI.md:167-222](file://docs/CODE_WIKI.md#L167-L222)
- [docs/CODE_WIKI.md:223-386](file://docs/CODE_WIKI.md#L223-L386)
...
**图示来源**
- [docs/CODE_WIKI.md:722-754](file://docs/CODE_WIKI.md#L722-L754)

**章节来源**
- [AGENTS.md:148-186](file://AGENTS.md#L148-L186)
- [docs/ARCHITECTURE.md:137-146](file://docs/ARCHITECTURE.md#L137-L146)
...
**章节来源**
- [Cargo.toml:17-72](file://Cargo.toml#L17-L72)
...
**章节来源**
- [docs/testing_guidelines.md:328-356](file://docs/testing_guidelines.md#L328-L356)
- [docs/ARCHITECTURE.md:150-184](file://docs/ARCHITECTURE.md#L150-L184)
- [start.sh:139-176](file://start.sh#L139-L176)
...
- [AGENTS.md:499-583](file://AGENTS.md#L499-L583)
- [docs/testing_guidelines.md:302-356](file://docs/testing_guidelines.md#L302-L356)

## 结论
AI Orz 提供了严谨的分层架构、类型安全的枚举与查询、完善的测试与 CI 质量门禁，以及高效的启动与构建脚本。遵循本指南的编码规范与最佳实践，新加入的开发者可以快速上手并持续贡献高质量代码。

## 附录
- 快速开始：./start.sh dev（后端 http://localhost:3000，前端 http://localhost:8080）
- 构建发布：./start.sh prod（编译 release 并运行）
