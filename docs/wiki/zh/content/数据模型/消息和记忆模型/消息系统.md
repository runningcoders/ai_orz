...
- [migrations/20260428100000_add_reply_to_id_to_messages.sql](migrations/20260428100000_add_reply_to_id_to_messages.sql)
- [migrations/20260718000000_add_org_and_root_to_messages.sql](migrations/20260718000000_add_org_and_root_to_messages.sql)
- [migrations/20260720000000_add_scope_project_to_channels.sql](migrations/20260720000000_add_scope_project_to_channels.sql)
...
- [src/handlers/finance/message_channel/update_message_channel_status.rs](src/handlers/finance/message_channel/update_message_channel_status.rs)
...
- [src/models/message.rs](src/models/message.rs) — MessagePo 新增 external_key 字段
</cite>
...
> 本长文是「消息系统」主题的 **数据模型层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [消息系统（业务功能层）](docs/wiki/zh/content/功能模块/消息系统/消息系统.md)
...
图表来源
- [src/pkg/adapter/message.rs:1-200](src/pkg/adapter/message.rs#L1-L200)
- [src/service/domain/message/mod.rs:1-200](src/service/domain/message/mod.rs#L1-L200)
...
- [src/producer/message_channel.rs:1-200](src/producer/message_channel.rs#L1-L200)

章节来源
- [src/models/message.rs:1-690](src/models/message.rs#L1-L690)
- [common/src/enums/message.rs:1-189](common/src/enums/message.rs#L1-L189)
...
章节来源
- [src/models/message.rs:18-690](src/models/message.rs#L18-L690)
- [common/src/enums/message.rs:7-189](common/src/enums/message.rs#L7-L189)
- [src/models/message_channel.rs:19-260](src/models/message_channel.rs#L19-L260)
...
图表来源
- [src/handlers/finance/message/send_message.rs:1-200](src/handlers/finance/message/send_message.rs#L1-L200)
- [src/service/domain/message/mod.rs:1-200](src/service/domain/message/mod.rs#L1-L200)
- [src/service/dal/message.rs:1-200](src/service/dal/message.rs#L1-L200)
- [src/consumer/message.rs:1-200](src/consumer/message.rs#L1-L200)
- [src/producer/message_channel.rs:1-200](src/producer/message_channel.rs#L1-L200)
...
章节来源
- [src/models/message.rs:18-690](src/models/message.rs#L18-L690)
- [common/src/enums/message.rs:57-189](common/src/enums/message.rs#L57-L189)
...
图表来源
- [src/handlers/finance/message/send_message.rs:1-200](src/handlers/finance/message/send_message.rs#L1-L200)
- [src/handlers/finance/message/subscribe_sse.rs:1-200](src/handlers/finance/message/subscribe_sse.rs#L1-L200)
- [src/consumer/message.rs:1-200](src/consumer/message.rs#L1-L200)
...
- [src/models/message_channel.rs:139-155](src/models/message_channel.rs#L139-L155)
...
章节来源
- [src/handlers/finance/message/search_messages.rs:1-200](src/handlers/finance/message/search_messages.rs#L1-L200)
- [src/handlers/finance/message/list_messages.rs:1-200](src/handlers/finance/message/list_messages.rs#L1-L200)
- [src/service/dal/message.rs:1-200](src/service/dal/message.rs#L1-L200)
- [migrations/20260420000000_initial.sql:1-200](migrations/20260420000000_initial.sql#L1-L200)
- [migrations/20260508000000_message_channels.sql:1-200](migrations/20260508000000_message_channels.sql#L1-L200)
...
章节来源
- [src/models/message_channel.rs:115-260](src/models/message_channel.rs#L115-L260)
- [common/src/enums/message_channel.rs:9-122](common/src/enums/message_channel.rs#L9-L122)
- [src/producer/message_channel.rs:1-200](src/producer/message_channel.rs#L1-L200)
...
章节来源
- [src/models/message.rs:281-290](src/models/message.rs#L281-L290)
- [migrations/20260428100000_add_reply_to_id_to_messages.sql:1-200](migrations/20260428100000_add_reply_to_id_to_messages.sql#L1-L200)
- [migrations/20260718000000_add_org_and_root_to_messages.sql:1-200](migrations/20260718000000_add_org_and_root_to_messages.sql#L1-L200)
...
## 附录
- 建表迁移参考：
  - 消息表与基础字段：[migrations/20260420000000_initial.sql:1-200](migrations/20260420000000_initial.sql#L1-L200)
  - 渠道表与配置：[migrations/20260508000000_message_channels.sql:1-200](migrations/20260508000000_message_channels.sql#L1-L200)
  - 回复与根消息：[migrations/20260428100000_add_reply_to_id_to_messages.sql:1-200](migrations/20260428100000_add_reply_to_id_to_messages.sql#L1-L200)、[migrations/20260718000000_add_org_and_root_to_messages.sql:1-200](migrations/20260718000000_add_org_and_root_to_messages.sql#L1-L200)
  - 渠道范围：[migrations/20260720000000_add_scope_project_to_channels.sql:1-200](migrations/20260720000000_add_scope_project_to_channels.sql#L1-L200)
...
**主题**：MessagePo 新增 external_key + reply_to/root_id 回复链完善
**关键变更**：
1. MessagePo 新增 external_key: Option<String> 字段——关联外部系统话题（如飞书 thread_id、微信 group_id），跨渠道同话题消息聚合
2. reply_to_id + root_id 回复链完善——根消息自动标记为 root_id=self，按 root_id 拉取完整对话链
3. 新增 migration 20260909000004_add_external_key_to_messages.sql
4. MessagePo 类图更新——类图新增 external_key 字段定义
