...
> 本长文是「项目管理」主题的 **数据模型层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [项目管理（业务功能层）](docs/wiki/zh/content/功能模块/项目管理/项目管理.md)
...
- [src/service/dal/project.rs:211-221](src/service/dal/project.rs#L211-L221)
- [src/service/dao/project/mod.rs:39-147](src/service/dao/project/mod.rs#L39-L147)
- [migrations/20260420000000_initial.sql:73-115](migrations/20260420000000_initial.sql#L73-L115)
...
- [common/src/models/stats.rs:114-171](common/src/models/stats.rs#L114-L171)
...
- [common/src/models/stats.rs:151-171](common/src/models/stats.rs#L151-L171)
...
- [src/models/task.rs:178-183](src/models/task.rs#L178-L183)
- [src/models/project.rs:179-183](src/models/project.rs#L179-L183)
- [common/src/models/stats.rs:151-171](common/src/models/stats.rs#L151-L171)
...
- [src/service/dao/project/mod.rs:12-37](src/service/dao/project/mod.rs#L12-L37)
- [src/service/domain/project/mod.rs:145-179](src/service/domain/project/mod.rs#L145-L179)
- [common/src/api/project.rs:214-248](common/src/api/project.rs#L214-L248)
...
图表来源
- [src/models/project.rs:15-80](src/models/project.rs#L15-L80)
- [src/models/project.rs:82-141](src/models/project.rs#L82-L141)
...
- [src/models/task.rs:334-342](src/models/task.rs#L334-L342)
...
章节来源
- [common/src/api/project.rs:10-251](common/src/api/project.rs#L10-L251)
...
图表来源
- [src/service/domain/project/mod.rs:502-539](src/service/domain/project/mod.rs#L502-L539)
- [src/service/dal/project.rs:211-221](src/service/dal/project.rs#L211-L221)
- [src/service/dao/project/mod.rs:39-147](src/service/dao/project/mod.rs#L39-L147)
...
## 附录
- 关键路径参考：
  - 项目创建/更新/状态流转：[src/service/domain/project/mod.rs:111-226](src/service/domain/project/mod.rs#L111-L226)
  - 任务创建/更新/状态流转：[src/service/domain/project/mod.rs:228-359](src/service/domain/project/mod.rs#L228-L359)
  - 项目混合搜索实现：[src/service/dal/project.rs:490-703](src/service/dal/project.rs#L490-L703)
  - 项目进度汇总计算：[src/models/project.rs:324-359](src/models/project.rs#L324-L359)
  - 数据库表结构：[migrations/20260420000000_initial.sql:73-115](migrations/20260420000000_initial.sql#L73-L115)