...
- [docs/superpowers/specs/enhance-memory-search/checklist.md](docs/superpowers/specs/enhance-memory-search/checklist.md)
...
- [src/service/domain/system/seed/skills/TEMPLATE_MEMORY_COGNITION/skill.md](src/service/domain/system/seed/skills/TEMPLATE_MEMORY_COGNITION/skill.md)
- [src/service/domain/system/seed/skills/TEMPLATE_COMMUNICATION/skill.md](src/service/domain/system/seed/skills/TEMPLATE_COMMUNICATION/skill.md)
- [tests/integration/preset_skills_test.rs](tests/integration/preset_skills_test.rs)
...
- [知识图谱 traverse：BFS levels 深度返回 + DFS 栈批量预取 edge_cache + IN 列表 400 分块防 999 溢出](docs/wiki/knowledge/zh/知识图谱 traverse：BFS levels 深度返回 + DFS 栈批量预取 edge_cache + IN 列表 400 分块防 999 溢出/知识图谱 traverse：BFS levels 深度返回 + DFS 栈批量预取 edge_cache + IN 列表 400 分块防 999 溢出.md)
</cite>
...
- [src/handlers/user/profile/update_current_user.rs:51-57](src/handlers/user/profile/update_current_user.rs#L51-L57)
- [src/service/domain/runtime/memory.rs:11-119](src/service/domain/runtime/memory.rs#L11-L119)
- [src/service/domain/runtime/awakening.rs:95-108](src/service/domain/runtime/awakening.rs#L95-L108)
- [src/service/dal/memory.rs:70-177](src/service/dal/memory.rs#L70-L177)
- [src/models/memory.rs:15-424](src/models/memory.rs#L15-L424)
- [src/models/user.rs:37-42](src/models/user.rs#L37-L42)
- [src/pkg/daily_jsonl.rs:1-110](src/pkg/daily_jsonl.rs#L1-L110)

**章节来源**
- [src/service/dal/mod.rs:1-52](src/service/dal/mod.rs#L1-L52)
...
- [src/service/domain/runtime/memory.rs:11-119](src/service/domain/runtime/memory.rs#L11-L119)
- [src/pkg/daily_jsonl.rs:1-110](src/pkg/daily_jsonl.rs#L1-L110)
- [docs/superpowers/specs/enhance-memory-search/checklist.md:18-59](docs/superpowers/specs/enhance-memory-search/checklist.md#L18-L59)
- [src/models/user.rs:37-42](src/models/user.rs#L37-L42)
- [common/src/api/user.rs:31-33](common/src/api/user.rs#L31-L33)
...
- [src/handlers/hr/agent/save_short_term_memory.rs:30-57](src/handlers/hr/agent/save_short_term_memory.rs#L30-L57)
- [src/handlers/user/profile/update_current_user.rs:51-57](src/handlers/user/profile/update_current_user.rs#L51-L57)
- [src/service/domain/runtime/memory.rs:39-67](src/service/domain/runtime/memory.rs#L39-L67)
- [src/service/domain/runtime/awakening.rs:95-108](src/service/domain/runtime/awakening.rs#L95-L108)
- [src/consumer/message.rs:340-346](src/consumer/message.rs#L340-346)
- [src/service/dal/memory.rs:377-390](src/service/dal/memory.rs#L377-L390)
...
**图表来源**
- [src/models/memory.rs:15-424](src/models/memory.rs#L15-L424)
- [src/models/user.rs:12-42](src/models/user.rs#L12-L42)
...
- [src/models/user.rs:37-42](src/models/user.rs#L37-L42)
- [src/models/user.rs:50-71](src/models/user.rs#L50-L71)
- [common/src/api/user.rs:31-33](common/src/api/user.rs#L31-L33)
- [common/src/api/user.rs:44-53](common/src/api/user.rs#L44-L53)
- [src/handlers/user/profile/update_current_user.rs:51-57](src/handlers/user/profile/update_current_user.rs#L51-L57)
- [src/service/domain/system/seed/skills/TEMPLATE_MEMORY_COGNITION/skill.md:47-61](src/service/domain/system/seed/skills/TEMPLATE_MEMORY_COGNITION/skill.md#L47-L61)
- [src/service/domain/system/seed/skills/TEMPLATE_COMMUNICATION/skill.md:76-77](src/service/domain/system/seed/skills/TEMPLATE_COMMUNICATION/skill.md#L76-L77)
- [src/consumer/message.rs:340-346](src/consumer/message.rs#L340-346)
- [src/service/domain/runtime/awakening.rs:95-108](src/service/domain/runtime/awakening.rs#L95-L108)
- [tests/integration/preset_skills_test.rs:169-199](tests/integration/preset_skills_test.rs#L169-L199)
...
**章节来源**
- [src/service/dal/memory.rs:400-506](src/service/dal/memory.rs#L400-L506)
- [src/service/dal/memory.rs:654-799](src/service/dal/memory.rs#L654-L799)
- [src/pkg/daily_jsonl.rs:75-103](src/pkg/daily_jsonl.rs#L75-L103)
- [src/handlers/user/profile/update_current_user.rs:51-57](src/handlers/user/profile/update_current_user.rs#L51-L57)
