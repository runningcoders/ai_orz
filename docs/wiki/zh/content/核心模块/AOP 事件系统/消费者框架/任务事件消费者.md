...
- [mod.rs（AOP）](src/pkg/aop/mod.rs)
- [registry.rs](src/pkg/aop/core/registry.rs)
- [consumer.rs](src/pkg/aop/core/consumer.rs)
- [task_status.rs](src/models/events/task_status.rs)
- [mod.rs（events）](src/models/events/mod.rs)
- [task.rs](src/models/task.rs)
- [project/mod.rs](src/service/domain/project/mod.rs)
- [message/mod.rs](src/service/domain/message/mod.rs)
</cite>

## 更新摘要
**变更内容**
- 事件类型标识由 `EventKind` 统一为 `common::enums::EventTopic`（点分线字符串，16 变体）；类图中 `TaskStatusChangedEvent::kind()` 返回 `EventTopic`
- 消费者订阅声明由 `interested_events()` 改为 `subscriptions() -> Vec<Subscription>`；`Consumer` trait 删除 `ack` / `nack` / `source`，收尾统一在 `Registry::finish_consumption` 按 topic 反查 producer
- `task.status_changed` 目前**没有注册 producer**（无 `notify_producer` 声明）→ 该主题的消费失败会走 `delivery_of` 兜底 `Nack`；文中若描述「自动写 system_delivery_attempts」属旧行为，已随 `Consumer::ack/nack` 一并删除
...
> 本长文是「任务事件消费者」主题的 **代码落地层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [任务事件消费者（框架层）](docs/wiki/zh/content/基础设施/AOP 事件系统/事件消费者/任务事件消费者.md)
...
- [registry.rs:97-206](src/pkg/aop/core/registry.rs#L97-L206)
...
- [project/mod.rs:131-133](src/service/domain/project/mod.rs#L131-L133)
- [task.rs:317-332](src/models/task.rs#L317-L332)

**章节来源**
- [task_event_consumer.rs:1-138](src/consumer/task_event_consumer.rs#L1-L138)
- [mod.rs（consumer）:1-43](src/consumer/mod.rs#L1-L43)
- [mod.rs（AOP）:1-61](src/pkg/aop/mod.rs#L1-L61)
- [registry.rs:1-561](src/pkg/aop/core/registry.rs#L1-L561)
- [consumer.rs:1-72](src/pkg/aop/core/consumer.rs#L1-L72)
- [task_status.rs:1-66](src/models/events/task_status.rs#L1-L66)
- [mod.rs（events）:1-21](src/models/events/mod.rs#L1-L21)
- [task.rs:1-343](src/models/task.rs#L1-L343)
- [project/mod.rs:1-539](src/service/domain/project/mod.rs#L1-L539)
- [message/mod.rs:1-378](src/service/domain/message/mod.rs#L1-L378)
...
**章节来源**
- [task_status.rs:5-66](src/models/events/task_status.rs#L5-L66)
- [consumer.rs:6-72](src/pkg/aop/core/consumer.rs#L6-L72)
- [registry.rs:97-206](src/pkg/aop/core/registry.rs#L97-L206)
- [task_event_consumer.rs:38-137](src/consumer/task_event_consumer.rs#L38-L137)
- [message/mod.rs:107-117](src/service/domain/message/mod.rs#L107-L117)
- [project/mod.rs:131-133](src/service/domain/project/mod.rs#L131-L133)
...
**图表来源**
- [registry.rs:97-206](src/pkg/aop/core/registry.rs#L97-L206)
- [registry.rs:208-449](src/pkg/aop/core/registry.rs#L208-L449)
...
- [mod.rs（AOP）:53-61](src/pkg/aop/mod.rs#L53-L61)
- [registry.rs:260-449](src/pkg/aop/core/registry.rs#L260-L449)
...
**章节来源**
- [task_event_consumer.rs:52-137](src/consumer/task_event_consumer.rs#L52-L137)
- [registry.rs:149-206](src/pkg/aop/core/registry.rs#L149-L206)
- [registry.rs:353-431](src/pkg/aop/core/registry.rs#L353-L431)
...
**章节来源**
- [task_status.rs:13-23](src/models/events/task_status.rs#L13-L23)
- [task_event_consumer.rs:60-137](src/consumer/task_event_consumer.rs#L60-L137)
...
**章节来源**
- [task_event_consumer.rs:85-137](src/consumer/task_event_consumer.rs#L85-L137)
- [message/mod.rs:281-331](src/service/domain/message/mod.rs#L281-L331)
- [registry.rs:116-142](src/pkg/aop/core/registry.rs#L116-L142)
...
- [mod.rs（consumer）:16-37](src/consumer/mod.rs#L16-L37)
- [mod.rs（AOP）:53-61](src/pkg/aop/mod.rs#L53-L61)
- [registry.rs:500-553](src/pkg/aop/core/registry.rs#L500-L553)
- [task_event_consumer.rs:60-137](src/consumer/task_event_consumer.rs#L60-L137)
