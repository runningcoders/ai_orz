...
- [src/handlers/finance/tool/unbind_tool_from_agent.rs](src/handlers/finance/tool/unbind_tool_from_agent.rs)
...
章节来源
- [src/models/tool.rs:57-202](src/models/tool.rs#L57-L202)
- [common/src/enums/tool.rs:9-162](common/src/enums/tool.rs#L9-L162)
- [src/service/domain/finance/tool_provider.rs:14-146](src/service/domain/finance/tool_provider.rs#L14-L146)
...
- [src/service/domain/finance/tool_provider.rs:14-114](src/service/domain/finance/tool_provider.rs#L14-L114)
...
- [src/handlers/finance/tool/create_tool.rs:12-62](src/handlers/finance/tool/create_tool.rs#L12-L62)

章节来源
- [src/handlers/finance/tool/create_tool.rs:1-72](src/handlers/finance/tool/create_tool.rs#L1-L72)
- [src/service/domain/finance/tool_provider.rs:14-66](src/service/domain/finance/tool_provider.rs#L14-L66)
...
章节来源
- [src/handlers/finance/tool/bind_tool_to_agent.rs:1-39](src/handlers/finance/tool/bind_tool_to_agent.rs#L1-L39)
- [src/service/domain/finance/tool_provider.rs:73-128](src/service/domain/finance/tool_provider.rs#L73-L128)
...
- [src/handlers/finance/tool/list_tool_tags.rs:1-28](src/handlers/finance/tool/list_tool_tags.rs#L1-L28)
...
- 创建工具
  ...
  - 示例路径：[create_tool.rs:12-72](src/handlers/finance/tool/create_tool.rs#L12-L72)
...
- 获取工具详情
  ...
  - 示例路径：[common/src/api/tool.rs:45-103](common/src/api/tool.rs#L45-L103)
...
- 更新工具
  ...
  - 示例路径：[common/src/api/tool.rs:244-270](common/src/api/tool.rs#L244-L270)

- 更新工具状态
  - 接口：PATCH /api/v1/tools/{id}/status
  - 请求体：UpdateToolStatusRequest（id、status）
  - 响应：UpdateToolStatusResponse（同 GetToolResponse）
  - 示例路径：[common/src/api/tool.rs:272-283](common/src/api/tool.rs#L272-L283)

- 删除工具
  - 接口：DELETE /api/v1/tools/{id}
  - 响应：DeleteToolResponse（success）
  - 示例路径：[common/src/api/tool.rs:105-118](common/src/api/tool.rs#L105-L118)
...
- 绑定工具到 Agent
  ...
  - 示例路径：[bind_tool_to_agent.rs:9-39](src/handlers/finance/tool/bind_tool_to_agent.rs#L9-L39)
...
- 从 Agent 解绑工具
  ...
  - 示例路径：[common/src/api/tool.rs:303-319](common/src/api/tool.rs#L303-L319)
...
- 调试调用工具（管理员）
  ...
  - 示例路径：[debug_call_tool.rs:12-35](src/handlers/finance/tool/debug_call_tool.rs#L12-L35)
...
- 同步调用工具（内部系统工具）
  ...
  - 示例路径：[request_tool_call.rs:11-54](src/handlers/finance/tool/request_tool_call.rs#L11-L54)
...
- 异步调用工具（内部系统工具）
  ...
  - 示例路径：[send_tool_call_message.rs:11-57](src/handlers/finance/tool/send_tool_call_message.rs#L11-L57)
...
- 搜索工具
  ...
  - 示例路径：[search_tools.rs:16-53](src/handlers/finance/tool/search_tools.rs#L16-L53)

- 列出工具标签
  - 接口：GET /api/v1/finance/tools/tags
  - 请求体：ListToolTagsRequest（空）
  - 响应：ListToolTagsResponse（tags）
  - 示例路径：[list_tool_tags.rs:11-28](src/handlers/finance/tool/list_tool_tags.rs#L11-L28)
...
- 查询工具调用轨迹
  ...
  - 示例路径：[common/src/api/tool.rs:321-366](common/src/api/tool.rs#L321-L366)

- 获取单条调用轨迹
  - 接口：GET /api/v1/tools/calls/{call_id}
  - 查询参数：tool_id、agent_id、project_id、task_id
  - 响应：ToolCallEntryDetail
  - 示例路径：[common/src/api/tool.rs:368-385](common/src/api/tool.rs#L368-L385)

章节来源
- [common/src/api/tool.rs:9-430](common/src/api/tool.rs#L9-L430)
- [src/handlers/finance/tool/create_tool.rs:12-72](src/handlers/finance/tool/create_tool.rs#L12-L72)
- [src/handlers/finance/tool/bind_tool_to_agent.rs:9-39](src/handlers/finance/tool/bind_tool_to_agent.rs#L9-L39)
- [src/handlers/finance/tool/debug_call_tool.rs:12-35](src/handlers/finance/tool/debug_call_tool.rs#L12-L35)
- [src/handlers/finance/tool/request_tool_call.rs:11-54](src/handlers/finance/tool/request_tool_call.rs#L11-L54)
- [src/handlers/finance/tool/send_tool_call_message.rs:11-57](src/handlers/finance/tool/send_tool_call_message.rs#L11-L57)
- [src/handlers/finance/tool/search_tools.rs:16-53](src/handlers/finance/tool/search_tools.rs#L16-L53)
- [src/handlers/finance/tool/list_tool_tags.rs:11-28](src/handlers/finance/tool/list_tool_tags.rs#L11-L28)