...
- [src/service/domain/message/mod.rs:119-378](src/service/domain/message/mod.rs#L119-L378)
- [src/handlers/finance/message/send_message.rs:1-41](src/handlers/finance/message/send_message.rs#L1-L41)
- [src/handlers/finance/message/search_messages.rs:1-79](src/handlers/finance/message/search_messages.rs#L1-L79)
- [src/handlers/finance/message/subscribe_sse.rs:1-93](src/handlers/finance/message/subscribe_sse.rs#L1-L93)
...
图表来源
- [src/models/message.rs:18-247](src/models/message.rs#L18-L247)
- [src/models/message.rs:249-400](src/models/message.rs#L249-L400)
- [src/models/message.rs:402-571](src/models/message.rs#L402-L571)
- [src/models/message.rs:573-612](src/models/message.rs#L573-L612)

章节来源
- [src/models/message.rs:18-612](src/models/message.rs#L18-L612)
...
图表来源
- [src/handlers/finance/message/search_messages.rs:1-79](src/handlers/finance/message/search_messages.rs#L1-L79)
- [src/service/domain/message/mod.rs:333-378](src/service/domain/message/mod.rs#L333-L378)
...
- [src/models/message.rs:640-651](src/models/message.rs#L640-L651)
...
图表来源
- [src/handlers/finance/message/mod.rs:1-17](src/handlers/finance/message/mod.rs#L1-L17)
- [src/service/domain/message/mod.rs:1-66](src/service/domain/message/mod.rs#L1-L66)
- [src/consumer/message.rs:1-63](src/consumer/message.rs#L1-L63)
...
- [src/service/domain/message/delivery.rs:271-330](src/service/domain/message/delivery.rs#L271-L330)
...
- 消息发送示例
  ...
  - 参考实现路径：[send_message.rs:1-41](src/handlers/finance/message/send_message.rs#L1-L41)
- 实时订阅代码
  - 路径：GET /api/v1/finance/messages/sse
  - 行为：建立 SSE 流，每 15 秒保活，断开自动注销
  - 参考实现路径：[subscribe_sse.rs:1-93](src/handlers/finance/message/subscribe_sse.rs#L1-L93)
- 消息检索最佳实践
  - 优先使用 keyword 走 FTS5；需要语义理解时加入 query_vector；两者并存启用混合搜索。
  - 合理设置 limit/top_k，避免全量扫描。
  - 参考实现路径：[search_messages.rs:1-79](src/handlers/finance/message/search_messages.rs#L1-L79)
