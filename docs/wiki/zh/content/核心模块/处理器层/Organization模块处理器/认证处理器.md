...
图表来源
- [src/router.rs:96-126](file://src/router.rs#L96-L126)
...
- [src/pkg/jwt.rs:70-136](file://src/pkg/jwt.rs#L70-L136)
...
章节来源
- [src/handlers/organization/auth/logout.rs:15-39](file://src/handlers/organization/auth/logout.rs#L15-L39)
- [common/src/api/auth.rs:29-38](file://common/src/api/auth.rs#L29-L38)
...
图表来源
- [src/middleware/jwt_auth.rs:25-87](file://src/middleware/jwt_auth.rs#L25-L87)
- [src/pkg/jwt.rs:94-136](file://src/pkg/jwt.rs#L94-L136)
...
章节来源
- [src/service/domain/organization/user.rs:85-117](file://src/service/domain/organization/user.rs#L85-L117)
- [src/service/domain/organization/mod.rs:125-199](file://src/service/domain/organization/mod.rs#L125-L199)
...
- 登录
  ...
  - 参考：[common/src/api/auth.rs:5-27](file://common/src/api/auth.rs#L5-L27)、[src/handlers/organization/auth/login.rs:18-68](file://src/handlers/organization/auth/login.rs#L18-L68)

- 登出
  - 方法：POST
  - 路径：/organization/auth/logout
  - 响应：success=true；同时清除 Cookie
  - 参考：[src/handlers/organization/auth/logout.rs:15-39](file://src/handlers/organization/auth/logout.rs#L15-L39)、[common/src/api/auth.rs:29-38](file://common/src/api/auth.rs#L29-L38)

- 受保护资源访问
  - 路径：/organization/*
  - 要求：有效的 JWT（Cookie 或 Authorization: Bearer）
  - 参考：[src/router.rs:96-126](file://src/router.rs#L96-L126)、[src/middleware/jwt_auth.rs:25-87](file://src/middleware/jwt_auth.rs#L25-L87)

- 管理员路由
  - 路径：/system/*
  - 要求：Admin 及以上角色
  - 参考：[src/router.rs:110-117](file://src/router.rs#L110-L117)、[src/middleware/require_role.rs:16-38](file://src/middleware/require_role.rs#L16-L38)
