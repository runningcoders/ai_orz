...
- [src/service/dao/project/sqlite.rs:1-200](src/service/dao/project/sqlite.rs#L1-L200)
...
- [src/handlers/project/projects/update_project.rs:1-41](src/handlers/project/projects/update_project.rs#L1-L41)
- [src/handlers/project/projects/update_project_status.rs:1-43](src/handlers/project/projects/update_project_status.rs#L1-L43)
- [src/service/domain/project/service.rs:1-200](src/service/domain/project/service.rs#L1-L200)
- [src/service/dal/project.rs:1-200](src/service/dal/project.rs#L1-L200)
- [src/service/dao/project/mod.rs:1-200](src/service/dao/project/mod.rs#L1-L200)
...
- 统计与向量
  - DuckDB 用于统计聚合，注意时间范围与分组粒度（minutely/hourly/daily）；粒度对窗口过细时后端按桶数上限自动收敛，无需调用方自行裁剪。
