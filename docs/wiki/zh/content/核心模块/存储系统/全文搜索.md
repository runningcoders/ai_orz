...
- [sqlite.rs（Skill）](src/service/dao/skill/sqlite.rs)
- [sqlite.rs（Tool）](src/service/dao/tool/sqlite.rs)
- [sqlite.rs（Agent）](src/service/dao/agent/sqlite.rs)
- [mod.rs（Message DAO）](src/service/dao/message/mod.rs)
- [message.rs（DAL）](src/service/dal/message.rs)
- [backup/mod.rs](src/handlers/system/backup/mod.rs)
</cite>
...
> 本长文是「全文搜索」主题的 **代码落地层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [全文搜索（框架层）](docs/wiki/zh/content/基础设施/存储系统/全文搜索.md)
...
- [20260712000001_entity_fts5.sql:1-246](migrations/20260712000001_entity_fts5.sql#L1-L246)
- [fts5.rs:1-45](src/pkg/storage/fts5.rs#L1-L45)
- [sqlite.rs（Skill）:335-363](src/service/dao/skill/sqlite.rs#L335-L363)
- [sqlite.rs（Tool）:402-453](src/service/dao/tool/sqlite.rs#L402-L453)
- [sqlite.rs（Agent）:155-186](src/service/dao/agent/sqlite.rs#L155-L186)
- [mod.rs（Message DAO）:162-176](src/service/dao/message/mod.rs#L162-L176)
- [memory.rs:70-86](src/service/dal/memory.rs#L70-L86)
- [task.rs:405-472](src/service/dal/task.rs#L405-L472)
- [message.rs:564-579](src/service/dal/message.rs#L564-L579)
...
**章节来源**
- [fts5.rs:6-18](src/pkg/storage/fts5.rs#L6-L18)
- [20260712000000_memory_fts5.sql:32-79](migrations/20260712000000_memory_fts5.sql#L32-L79)
- [20260712000001_entity_fts5.sql:68-217](migrations/20260712000001_entity_fts5.sql#L68-L217)
- [task.rs:405-430](src/service/dal/task.rs#L405-L430)
- [backup/mod.rs:19-32](src/handlers/system/backup/mod.rs#L19-L32)
...
- [sqlite.rs（Tool）:402-453](src/service/dao/tool/sqlite.rs#L402-L453)
- [sqlite.rs（Agent）:155-186](src/service/dao/agent/sqlite.rs#L155-L186)
- [task.rs:513-542](src/service/dal/task.rs#L513-L542)
- [message.rs:564-579](src/service/dal/message.rs#L564-L579)