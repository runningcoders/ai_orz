...
> 本长文是「向量存储抽象接口」主题的 **代码落地层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [向量存储抽象接口（框架层）](docs/wiki/zh/content/基础设施/存储系统/向量存储/向量存储抽象接口.md)
...
- [src/pkg/storage/vector.rs:84-235](src/pkg/storage/vector.rs#L84-L235)
...
- [docs/vector_search_architecture.md:120-131](docs/vector_search_architecture.md#L120-L131)
