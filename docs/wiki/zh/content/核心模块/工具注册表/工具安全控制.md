...
- [src/pkg/tool_registry/shell_exec.rs:257-466](src/pkg/tool_registry/shell_exec.rs#L257-L466)
...
- [src/pkg/tool_tracing/logger.rs:64-140](src/pkg/tool_tracing/logger.rs#L64-L140)
...
- [src/pkg/tool_registry/fs_read.rs:1-255](src/pkg/tool_registry/fs_read.rs#L1-L255)
- [src/pkg/tool_registry/fs_write.rs:1-427](src/pkg/tool_registry/fs_write.rs#L1-L427)
...
- [src/pkg/tool_tracing/logger.rs:1-253](src/pkg/tool_tracing/logger.rs#L1-L253)
...
- [src/pkg/tool_registry/fs_read.rs:15-35](src/pkg/tool_registry/fs_read.rs#L15-L35)
...
- [src/models/events/tool_exec.rs:1-65](src/models/events/tool_exec.rs#L1-L65)
- [src/pkg/tool_tracing/entry.rs:70-91](src/pkg/tool_tracing/entry.rs#L70-L91)
- [src/pkg/tool_tracing/logger.rs:1-140](src/pkg/tool_tracing/logger.rs#L1-L140)
...
- [src/pkg/tool_registry/http.rs:41-73](src/pkg/tool_registry/http.rs#L41-L73)
- [src/pkg/tool_registry/http.rs:98-220](src/pkg/tool_registry/http.rs#L98-L220)
- [src/pkg/tool_registry/http.rs:369-589](src/pkg/tool_registry/http.rs#L369-L589)
...
- 日志存储：Daily JSONL 文件，路径为 base_data_path/tools/call_trace/{YYYYMMDD}.jsonl（不按 tool_id 分目录）。
...
Consumer->>Logger : log_call(entry)
