...
章节来源
- [src/pkg/aop/mod.rs:1-61](src/pkg/aop/mod.rs#L1-L61)
- [common/src/api/system.rs:55-129](common/src/api/system.rs#L55-L129)
...
## 附录
- 实际代码示例路径：
  - AOP 发布与调度：[src/pkg/aop/mod.rs:1-61](src/pkg/aop/mod.rs#L1-L61)
  - 健康检查端点：[src/handlers/health.rs:1-16](src/handlers/health.rs#L1-L16)
  - 系统指标聚合：[src/handlers/system/health_metrics.rs:1-135](src/handlers/system/health_metrics.rs#L1-L135)
  - Stats 记录与全局访问：[src/pkg/stats/mod.rs:1-175](src/pkg/stats/mod.rs#L1-L175)
  - 种子数据 API：[common/src/api/seed.rs:1-163](common/src/api/seed.rs#L1-L163)
