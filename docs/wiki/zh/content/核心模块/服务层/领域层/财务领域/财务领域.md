...
- [src/service/domain/finance/message_channel.rs:13-73](src/service/domain/finance/message_channel.rs#L13-L73)
...
图表来源
- [src/service/domain/finance/model_provider.rs:54-101](src/service/domain/finance/model_provider.rs#L54-L101)
- [src/models/model_provider.rs:9-68](src/models/model_provider.rs#L9-L68)
...
图表来源
- [src/models/message_channel.rs:67-113](src/models/message_channel.rs#L67-L113)

章节来源
- [src/models/message_channel.rs:19-113](src/models/message_channel.rs#L19-L113)
- [src/models/message_channel.rs:115-255](src/models/message_channel.rs#L115-L255)
- [src/service/domain/finance/message_channel.rs:13-73](src/service/domain/finance/message_channel.rs#L13-L73)
- [src/handlers/finance/message_channel/mod.rs:1-22](src/handlers/finance/message_channel/mod.rs#L1-L22)
...
- [src/service/domain/finance/tool_provider.rs:57-66](src/service/domain/finance/tool_provider.rs#L57-L66)
...
- [src/models/message_channel.rs:67-113](src/models/message_channel.rs#L67-L113)
- [src/service/domain/finance/tool_provider.rs:77-101](src/service/domain/finance/tool_provider.rs#L77-L101)
- [src/service/domain/finance/attachment.rs:88-124](src/service/domain/finance/attachment.rs#L88-L124)
...
## 附录
- 实际代码示例路径
  - 模型提供商配置与连接测试：[src/service/domain/finance/model_provider.rs:54-101](src/service/domain/finance/model_provider.rs#L54-L101)
  - MCP 服务器注册与配置脱敏：[src/service/domain/finance/mcp_server.rs:13-81](src/service/domain/finance/mcp_server.rs#L13-L81)
  - 消息渠道状态迁移与测试：[src/service/domain/finance/message_channel.rs:13-73](src/service/domain/finance/message_channel.rs#L13-L73)
  - 工具提供商绑定与搜索：[src/service/domain/finance/tool_provider.rs:77-145](src/service/domain/finance/tool_provider.rs#L77-L145)
  - 附件上传与文本内容更新：[src/service/domain/finance/attachment.rs:17-137](src/service/domain/finance/attachment.rs#L17-L137)
