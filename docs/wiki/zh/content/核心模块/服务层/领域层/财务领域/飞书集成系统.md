...
- [docs/archive/design-archive/lark_cli_integration.md](docs/archive/design-archive/lark_cli_integration.md)
...
- [src/pkg/tool_registry/lark_cli.rs](src/pkg/tool_registry/lark_cli.rs)
...
- [src/handlers/finance/message_channel/response.rs](src/handlers/finance/message_channel/response.rs)
...
- [src/service/dao/user/mod.rs](src/service/dao/user/mod.rs)
- [src/service/dao/lark/ws.rs](src/service/dao/lark/ws.rs)

**本文关联三类文档**
- 【① Design 决策快照】
  - [lark_cli_integration.md](docs/archive/design-archive/lark_cli_integration.md) — 凭证变更 WS 移交、HOME 隔离、清 CLI config、WS 指数退避
  - [message_channel_design.md](docs/archive/design-archive/message_channel_design.md) — 渠道引用检查、凭证加密策略、入站适配中台
- 【② Plan 落地快照（真实定稿）】
  - [身份凭证Domain统一CRUD重构.md](docs/archive/plan-archive/身份凭证Domain统一CRUD重构.md) — Lark 类型 4 Handler 迁移 + match kind 副作用完整说明
  - [lark-cli_集成二期.md](docs/archive/plan-archive/lark-cli_集成二期.md) — 凭证用户级 + OAuth 身份 + WS 稳定性三项增强（二期）
...
- 【③ Wiki 关联长文】
  ...
  - [消息渠道管理.md](docs/wiki/zh/content/功能模块/消息系统/消息渠道管理.md) — 飞书渠道 resolve_lark_credential_ref 统一校验
  - [消息渠道适配器.md](docs/wiki/zh/content/项目概述/核心功能特性/多渠道消息系统/消息渠道适配器.md) — 入站适配中台 + 出站推送完整链路
  - [系统健康检查.md](docs/wiki/zh/content/项目概述/核心功能特性/系统管理功能/系统健康检查.md) — LarkWsMetrics 健康指标接入与聚合观测
</cite>
...
**Batch2 2026-08-15 增量同步**：针对 IdentityCredentialManage trait 收敛（lark 5 方法封顶）、lark 4 Handler 迁移调用统一 create_credential/update_credential/delete_credential/set_default_credential、LarkApp 凭证 update 后清 HOME config + WS 移交、delete_credential Lark 渠道引用前置检查 Conflict 拒删 4 项增量完成同步。cite 区补 4 类文档互引闭环（2 Design + 真实 Plan + 4 RAG + 2 关联长文）。§5 新增「LarkApp 凭证生命周期联动（update WS 移交 / delete 渠道引用检查）」小节。§8 Troubleshooting 补 2 条。
...
**图表来源**
- [src/router.rs:75-130](src/router.rs#L75-L130)
- [src/handlers/finance/lark_integration/mod.rs:1-18](src/handlers/finance/lark_integration/mod.rs#L1-L18)
- [src/service/domain/finance/message_channel.rs:12-38](src/service/domain/finance/message_channel.rs#L12-L38)
- [src/service/dal/lark.rs:65-142](src/service/dal/lark.rs#L65-L142)
...
**章节来源**
- [src/router.rs:175-247](src/router.rs#L175-L247)
- [src/handlers/finance/lark_integration/mod.rs:1-18](src/handlers/finance/lark_integration/mod.rs#L1-L18)
- [src/pkg/tool_registry/lark_cli.rs:1-39](src/pkg/tool_registry/lark_cli.rs#L1-L39)
- [docs/archive/design-archive/lark_cli_integration.md:144-162](docs/archive/design-archive/lark_cli_integration.md#L144-L162)
...
**图表来源**
- [src/lib.rs:114-199](src/lib.rs#L114-L199)
- [src/lib.rs:244-284](src/lib.rs#L244-L284)
...
- [common/src/models/identity_credentials.rs:11-77](common/src/models/identity_credentials.rs#L11-L77)
...
**章节来源**
- [src/pkg/lark_integration.rs:263-362](src/pkg/lark_integration.rs#L263-L362)
...
**章节来源**
- [src/pkg/lark_integration.rs:364-612](src/pkg/lark_integration.rs#L364-L612)
...
**图表来源**
- [src/service/dao/lark/ws.rs:228-279](src/service/dao/lark/ws.rs#L228-L279)
...
- [src/service/dal/lark.rs:161-223](src/service/dal/lark.rs#L161-L223)
- [src/service/dal/user.rs:73-87](src/service/dal/user.rs#L73-L87)
...
**章节来源**
- [src/service/dal/lark.rs:298-318](src/service/dal/lark.rs#L298-L318)
- [src/service/dal/lark.rs:581-612](src/service/dal/lark.rs#L581-L612)
...
- [tests/integration/message_channel_lifecycle_test.rs:1-20](tests/integration/message_channel_lifecycle_test.rs#L1-L20)
...
## 附录
- 设计文档：docs/archive/design-archive/lark_cli_integration.md
...
**章节来源**
- [docs/archive/design-archive/lark_cli_integration.md:1-196](docs/archive/design-archive/lark_cli_integration.md#L1-L196)
