...
- [docs/design/lark_cli_integration.md](docs/design/lark_cli_integration.md)
...
**本文关联三类文档**
- 【① Design 决策快照】
  - [lark_cli_integration.md](docs/design/lark_cli_integration.md) — 凭证变更 WS 移交、HOME 隔离、清 CLI config、WS 指数退避
  - [message_channel_design.md](docs/design/message_channel_design.md) — 渠道引用检查、凭证加密策略、入站适配中台
- 【② Plan 落地快照（真实定稿）】
  - [身份凭证Domain统一CRUD重构.md](docs/plan/身份凭证Domain统一CRUD重构.md) — Lark 类型 4 Handler 迁移 + match kind 副作用完整说明
  - [lark-cli_集成二期.md](docs/plan/lark-cli_集成二期.md) — 凭证用户级 + OAuth 身份 + WS 稳定性三项增强（二期）
  - [飞书P2P消息集成.md](docs/plan/飞书P2P消息集成.md) — v4 AOP 入站中台落地 + 飞书私信双向闭环
- 【④ RAG 原子知识卡】
...
- [docs/design/lark_cli_integration.md:144-162](docs/design/lark_cli_integration.md#L144-L162)
...
**章节来源**
- [docs/design/lark_cli_integration.md:1-196](docs/design/lark_cli_integration.md#L1-L196)
