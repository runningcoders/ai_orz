...
- [tests/common/app.rs](tests/common/app.rs)
- [tests/common/assertions.rs](tests/common/assertions.rs)
- [tests/common/factories/mod.rs](tests/common/factories/mod.rs)
- [tests/common/factories/user_factory.rs](tests/common/factories/user_factory.rs)
...
- [tests/integration/message_channel_lifecycle_test.rs](tests/integration/message_channel_lifecycle_test.rs)
- [tests/integration/browser_tool_test.rs](tests/integration/browser_tool_test.rs)
- [tests/e2e/playwright.config.ts](tests/e2e/playwright.config.ts)
- [tests/e2e/tests/auth.setup.ts](tests/e2e/tests/auth.setup.ts)
- [tests/e2e/tests/navigation.spec.ts](tests/e2e/tests/navigation.spec.ts)
- [tests/e2e/scripts/start-server.mjs](tests/e2e/scripts/start-server.mjs)
- [src/service/dal/lark_test.rs](src/service/dal/lark_test.rs)
- [src/service/dal/message_channel_test.rs](src/service/dal/message_channel_test.rs)
- [common/src/models/identity_credentials.rs](common/src/models/identity_credentials.rs)
- [src/pkg/lark_integration.rs](src/pkg/lark_integration.rs)
- [common/src/api/lark_integration.rs](common/src/api/lark_integration.rs)
- [.github/workflows/rust.yml](.github/workflows/rust.yml)
- [docs/archive/design-archive/testing_guidelines.md](docs/archive/design-archive/testing_guidelines.md)
- [src/service/domain/message/delivery_test.rs](src/service/domain/message/delivery_test.rs)
...
- **迁移统一（2026-08）**：测试总数从 1124 统一调整为 974，合并了重复的测试模块；E2E 测试路径从 `e2e/` 迁移到 `tests/e2e/`，与项目目录规范对齐；新增 `tests/integration/browser_tool_test.rs`、`tests/integration/message_channel_lifecycle_test.rs`、`src/service/dal/message_channel_test.rs` 等测试文件
...
- E2E 测试：位于 tests/e2e/，基于 Playwright 的浏览器端到端测试，覆盖用户真实操作流程（登录、导航、表单交互），支持 auth.setup.ts 鉴权 Fixture 和 navigation.spec.ts 导航测试。
...
- [tests/common/app.rs:16-289](tests/common/app.rs#L16-L289)
- [tests/common/assertions.rs:1-46](tests/common/assertions.rs#L1-L46)
- [tests/common/factories/user_factory.rs:70-178](tests/common/factories/user_factory.rs#L70-L178)
- [tests/integration/lark_integration_test.rs:1-289](tests/integration/lark_integration_test.rs#L1-L289)
- [tests/integration/message_channel_lifecycle_test.rs:1-208](tests/integration/message_channel_lifecycle_test.rs#L1-L208)

**章节来源**
- [tests/common/mod.rs:1-19](tests/common/mod.rs#L1-L19)
- [tests/common/env.rs:1-88](tests/common/env.rs#L1-L88)
- [tests/common/app.rs:1-289](tests/common/app.rs#L1-L289)
- [tests/common/assertions.rs:1-46](tests/common/assertions.rs#L1-L46)
- [tests/common/factories/mod.rs:1-15](tests/common/factories/mod.rs#L1-L15)
...
**章节来源**
- [src/service/domain/message/delivery_test.rs:23-69](src/service/domain/message/delivery_test.rs#L23-L69)
- [src/service/dal/lark_test.rs:1-283](src/service/dal/lark_test.rs#L1-L283)
...
**章节来源**
- [tests/integration/auth_sysinit_test.rs:1-28](tests/integration/auth_sysinit_test.rs#L1-L28)
- [tests/integration/core_crud_test.rs:1-337](tests/integration/core_crud_test.rs#L1-L337)
- [tests/integration/lark_integration_test.rs:1-289](tests/integration/lark_integration_test.rs#L1-L289)
- [tests/integration/message_channel_lifecycle_test.rs:1-208](tests/integration/message_channel_lifecycle_test.rs#L1-L208)
- [tests/common/app.rs:16-289](tests/common/app.rs#L16-L289)
- [tests/common/assertions.rs:1-46](tests/common/assertions.rs#L1-L46)
...
- 实现要点：
  ...
  - **Playwright E2E**：位于 `tests/e2e/`，包含 `playwright.config.ts` 配置、`tests/auth.setup.ts` 登录鉴权 Fixture、`tests/navigation.spec.ts` 导航测试、`scripts/start-server.mjs` 服务器启动脚本。

**更新** 飞书集成的端到端测试特别关注无 CLI 环境下的用户体验，确保所有操作都能返回友好的引导信息。

**章节来源**
- [tests/common/factories/user_factory.rs:70-178](tests/common/factories/user_factory.rs#L70-L178)
- [tests/common/app.rs:199-289](tests/common/app.rs#L199-L289)
...
- [src/service/domain/message/delivery_test.rs:23-69](src/service/domain/message/delivery_test.rs#L23-L69)
- [tests/common/factories/user_factory.rs:70-178](tests/common/factories/user_factory.rs#L70-L178)
- [tests/integration/lark_integration_test.rs:16-112](tests/integration/lark_integration_test.rs#L16-L112)
...
**章节来源**
- [tests/common/assertions.rs:1-46](tests/common/assertions.rs#L1-L46)
- [tests/integration/lark_integration_test.rs:31-98](tests/integration/lark_integration_test.rs#L31-L98)
- [tests/integration/message_channel_lifecycle_test.rs:101-152](tests/integration/message_channel_lifecycle_test.rs#L101-L152)
...
- [tests/common/factories/user_factory.rs:70-178](tests/common/factories/user_factory.rs#L70-L178)
- [tests/common/factories/mod.rs:1-15](tests/common/factories/mod.rs#L1-L15)
- [tests/integration/message_channel_lifecycle_test.rs:22-50](tests/integration/message_channel_lifecycle_test.rs#L22-L50)
...
**章节来源**
- [tests/common/env.rs:25-87](tests/common/env.rs#L25-L87)
- [src/service/mod.rs:6-28](src/service/mod.rs#L6-L28)
- [src/service/dao/mod.rs:29-56](src/service/dao/mod.rs#L29-L56)
...
- **Playwright E2E 路径**：`tests/e2e/`（从 `e2e/` 迁移统一），配置文件 `playwright.config.ts`，测试结果输出到 `tests/e2e/test-results/`
...
**章节来源**
- [.github/workflows/rust.yml:176-295](.github/workflows/rust.yml#L176-L295)
- [docs/archive/design-archive/testing_guidelines.md:388-396](docs/archive/design-archive/testing_guidelines.md#L388-L396)
...
# 浏览器工具集成测试
cargo test --test browser_tool_test
...
- [.github/workflows/rust.yml:90-129](.github/workflows/rust.yml#L90-L129)
...
- [tests/common/app.rs:199-289](tests/common/app.rs#L199-L289)
- [tests/integration/lark_integration_test.rs:16-112](tests/integration/lark_integration_test.rs#L16-L112)
- [src/pkg/lark_integration.rs:147-156](src/pkg/lark_integration.rs#L147-L156)
- [.github/workflows/rust.yml:68-74](.github/workflows/rust.yml#L68-L74)
...
### 测试规范文档
- [docs/testing_guidelines.md](docs/archive/design-archive/testing_guidelines.md)
