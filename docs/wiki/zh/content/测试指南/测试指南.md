...
- [docs/design/testing_guidelines.md](docs/design/testing_guidelines.md)
...
**② 落地计划（Plan）**：
- [Agent管理集成测试](docs/plan/Agent管理集成测试.md) — Agent 管理域全链路集成测试落地点；init_full_test_env 启动顺序 6 步对齐真实启动；向量降级 fallback

**【Batch10 追加互引】**
#### ① Design 决策快照（Batch10 追加 2 张）
- [browser_e2e_test_design.md](docs/design/browser_e2e_test_design.md) — Playwright E2E 双模式 Playbook 契约 + data-testid 选择器 + dioxus-playwright Fixture
- [seed-config-migration.md](docs/design/seed-config-migration.md) — 两阶段初始化（init_all 静态单例 / init_base_data 异步基础数据 / aop init 调度器）严格顺序；测试 init_full_test_env 必须对齐
...
- [docs/design/testing_guidelines.md:388-396](docs/design/testing_guidelines.md#L388-L396)
...
### 测试规范文档
- [docs/testing_guidelines.md](docs/design/testing_guidelines.md)
