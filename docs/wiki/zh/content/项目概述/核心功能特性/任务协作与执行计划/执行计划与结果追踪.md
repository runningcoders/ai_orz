...
- [AGENTS.md](AGENTS.md)
- [通过 common DTO 补全 Project/Task execution_plan/result 读取链路](docs/wiki/knowledge/zh/通过 common DTO 补全 Project_Task execution_plan_result 读取链路/通过 common DTO 补全 Project_Task execution_plan_result 读取链路.md)
...
- [src/models/project.rs:15-58](src/models/project.rs#L15-L58)
- [common/src/api/task.rs:190-214](common/src/api/task.rs#L190-L214)
- [common/src/api/project.rs:167-187](common/src/api/project.rs#L167-L187)
- [src/service/domain/runtime/tool_execution.rs:12-76](src/service/domain/runtime/tool_execution.rs#L12-L76)
- [src/pkg/tool_tracing/mod.rs:1-12](src/pkg/tool_tracing/mod.rs#L1-L12)
- [src/handlers/system/task_progress.rs:1-25](src/handlers/system/task_progress.rs#L1-L25)
- [src/handlers/system/health_metrics.rs:106-134](src/handlers/system/health_metrics.rs#L106-L134)
- [frontend/src/pages/project/task_detail.rs:224-259](frontend/src/pages/project/task_detail.rs#L224-L259)
...
章节来源
- [src/service/domain/runtime/tool_execution.rs:167-185](src/service/domain/runtime/tool_execution.rs#L167-L185)
- [src/pkg/tool_tracing/mod.rs:1-12](src/pkg/tool_tracing/mod.rs#L1-L12)
- [frontend/src/pages/project/task_detail.rs:224-259](frontend/src/pages/project/task_detail.rs#L224-L259)
...
章节来源
- [AGENTS.md:44-46](AGENTS.md#L44-L46)
- [AGENTS.md:1124-1128](AGENTS.md#L1124-L1128)