...
- [vector.rs（向量 DAO）](src/service/dao/memory/vector.rs)
...
- [memory.rs（DAL）:377-422](src/service/dal/memory.rs#L377-L422)
- [sqlite.rs（DAO）:165-235](src/service/dao/memory/sqlite.rs#L165-L235)
- [vector.rs（向量 DAO）:36-79](src/service/dao/memory/vector.rs#L36-L79)

章节来源
- [memory.rs（DAL）:1-177](src/service/dal/memory.rs#L1-L177)
- [sqlite.rs（DAO）:1-127](src/service/dao/memory/sqlite.rs#L1-L127)
...
- [memory.rs（DAL）:1381-1422](src/service/dal/memory.rs#L1381-L1422)
...
图表来源
- [memory.rs（DAL）:1381-1422](src/service/dal/memory.rs#L1381-L1422)
- [sqlite.rs（DAO）:165-192](src/service/dao/memory/sqlite.rs#L165-L192)
- [vector.rs（向量 DAO）:36-51](src/service/dao/memory/vector.rs#L36-L51)
...
章节来源
- [memory.rs:158-210](src/models/memory.rs#L158-L210)
- [memory.rs:399-407](src/models/memory.rs#L399-L407)
...
章节来源
- [memory.rs（DAL）:377-422](src/service/dal/memory.rs#L377-L422)
- [sqlite.rs（DAO）:298-381](src/service/dao/memory/sqlite.rs#L298-L381)
- [memory.rs（枚举）:12-30](common/src/enums/memory.rs#L12-L30)
...
章节来源
- [20260420000000_initial.sql:117-129](migrations/20260420000000_initial.sql#L117-L129)
- [20260420000000_initial.sql:246-253](migrations/20260420000000_initial.sql#L246-L253)
- [20260712000000_memory_fts5.sql:16-29](migrations/20260712000000_memory_fts5.sql#L16-L29)
- [sqlite.rs（DAO）:298-381](src/service/dao/memory/sqlite.rs#L298-L381)
...
图表来源
- [memory.rs（DAL）:1000-1148](src/service/dal/memory.rs#L1000-L1148)
- [sqlite.rs（DAO）:383-484](src/service/dao/memory/sqlite.rs#L383-L484)
...
- [sqlite.rs（DAO）:237-257](src/service/dao/memory/sqlite.rs#L237-L257)
...
图表来源
- [memory.rs（DAL）:1-177](src/service/dal/memory.rs#L1-L177)
- [vector.rs（向量 DAO）:1-34](src/service/dao/memory/vector.rs#L1-L34)
...
章节来源
- [memory.rs（DAL）:1381-1422](src/service/dal/memory.rs#L1381-L1422)
- [sqlite.rs（DAO）:194-235](src/service/dao/memory/sqlite.rs#L194-L235)
...
- 参考路径
  - [memory.rs（DAL）:392-429](src/service/dal/memory.rs#L392-L429)
  - [sqlite.rs（DAO）:194-235](src/service/dao/memory/sqlite.rs#L194-L235)
...
- 参考路径
  - [memory.rs:158-210](src/models/memory.rs#L158-L210)
  - [sqlite.rs（DAO）:105-123](src/service/dao/memory/sqlite.rs#L105-L123)