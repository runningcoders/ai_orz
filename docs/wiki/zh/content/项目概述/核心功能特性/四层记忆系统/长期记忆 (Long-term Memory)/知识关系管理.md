...
#### ① Design 决策快照
- [memory_search_enhancement_design.md](docs/design/memory_search_enhancement_design.md) — 搜索增强决策 3 关系搜索 JOIN 方式 + 决策 4 向量阈值参数化 0.8 默认
#### ② Plan 落地快照
- [知识图谱推荐起点与组件复用重构.md](docs/plan/知识图谱推荐起点与组件复用重构.md) — recommend_seed_nodes 冷启动起步入口 + KnowledgeGraph 子组件两端复用
#### ④ RAG 原子知识卡
