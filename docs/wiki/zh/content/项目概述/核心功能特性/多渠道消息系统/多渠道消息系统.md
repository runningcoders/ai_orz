...
- 【① Design 决策】[docs/design/message_channel_design.md](docs/design/message_channel_design.md) — 多渠道入站适配中台 + 5 类出站分发 + Webhook HMAC 签名
- 【② Plan 落地】[docs/plan/飞书P2P消息集成.md](docs/plan/飞书P2P消息集成.md) — 飞书 WS 入站 + 飞书卡片出站 双向闭环
