...
- [src/handlers/finance/message/send_message_to_agent.rs](src/handlers/finance/message/send_message_to_agent.rs)
...
- 【① Design 决策】[docs/archive/design-archive/message_channel_design.md](docs/archive/design-archive/message_channel_design.md) — 多渠道入站适配中台 + 5 类出站分发 + Webhook HMAC 签名
- 【② Plan 落地】[docs/archive/plan-archive/飞书P2P消息集成.md](docs/archive/plan-archive/飞书P2P消息集成.md) — 飞书 WS 入站 + 飞书卡片出站 双向闭环
- 【④ RAG 知识卡 1（Batch7 出站）】[消息交互与SSE推送](docs/wiki/knowledge/zh/消息交互与SSE推送：MessageDomain双能力%20+%20AgentLoopConsumer循环%20+%20多渠道出站5类/消息交互与SSE推送：MessageDomain双能力%20+%20AgentLoopConsumer循环%20+%20多渠道出站5类.md) — §MessagePushDao 5 类渠道分发（飞书卡片/Slack Block/Email SMTP/Webhook HMAC/微信客服）
- 【④ RAG 知识卡 2（Batch4 入站）】[消息渠道入站适配中台](docs/wiki/knowledge/zh/消息渠道入站适配中台：MessageInboundAdapter%20trait%20+%20MessageAdapterRegistry%20全局注册%20+%20start_all%20stop_all%20生命周期/消息渠道入站适配中台：MessageInboundAdapter%20trait%20+%20MessageAdapterRegistry%20全局注册%20+%20start_all%20stop_all%20生命周期.md) — 入站适配中台架构
- 【④ RAG 知识卡 3（Batch4 飞书 WS）】[Lark P2P WS 私信入站](docs/wiki/knowledge/zh/Lark%20P2P%20WS%20私信入站：身份凭证引用解析%20+%20app_id%20聚合%20WS%20+%20open_id%20自动映射%20+%20LarkWsMetrics%20健康指标/Lark%20P2P%20WS%20私信入站：身份凭证引用解析%20+%20app_id%20聚合%20WS%20+%20open_id%20自动映射%20+%20LarkWsMetrics%20健康指标.md) — 飞书 WS 入站实现
</cite>
...
- [src/producer/message_channel.rs:1-115](src/producer/message_channel.rs#L1-L115)
- [src/service/domain/message/mod.rs:1-378](src/service/domain/message/mod.rs#L1-L378)
- [src/service/dal/message_channel.rs:1-407](src/service/dal/message_channel.rs#L1-L407)
...
- [src/service/dal/message_channel.rs:1-407](src/service/dal/message_channel.rs#L1-L407)
- [src/consumer/message.rs:1-534](src/consumer/message.rs#L1-L534)
- [src/service/dal/lark.rs:1-336](src/service/dal/lark.rs#L1-L336)
...
- [src/pkg/adapter/message.rs:1-190](src/pkg/adapter/message.rs#L1-L190)
- [src/producer/message_channel.rs:1-115](src/producer/message_channel.rs#L1-L115)
- [src/service/domain/message/delivery.rs:1-461](src/service/domain/message/delivery.rs#L1-L461)
- [src/service/dal/message_channel.rs:1-407](src/service/dal/message_channel.rs#L1-L407)
- [src/consumer/message.rs:1-534](src/consumer/message.rs#L1-L534)
...
图表来源
- [src/service/dal/lark.rs:135-225](src/service/dal/lark.rs#L135-L225)
- [src/pkg/adapter/message.rs:36-71](src/pkg/adapter/message.rs#L36-L71)
...
图表来源
- [src/pkg/adapter/message.rs:36-190](src/pkg/adapter/message.rs#L36-L190)
- [src/service/dal/lark.rs:240-321](src/service/dal/lark.rs#L240-L321)
...
图表来源
- [src/service/domain/message/delivery.rs:51-461](src/service/domain/message/delivery.rs#L51-L461)
- [src/consumer/message.rs:147-389](src/consumer/message.rs#L147-L389)
...
章节来源
- [src/service/domain/message/delivery.rs:381-436](src/service/domain/message/delivery.rs#L381-L436)
- [src/handlers/a2a/send_subscribe.rs:62-123](src/handlers/a2a/send_subscribe.rs#L62-L123)
...
章节来源
- [src/handlers/finance/message/mod.rs:1-17](src/handlers/finance/message/mod.rs#L1-L17)
- [src/handlers/finance/message/send_message_to_agent.rs:1-35](src/handlers/finance/message/send_message_to_agent.rs#L1-L35)
- [src/handlers/a2a/send_subscribe.rs:1-193](src/handlers/a2a/send_subscribe.rs#L1-L193)