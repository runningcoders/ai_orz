...
**本文关联三类文档（四类互引闭环）**
- 【① Design 决策快照】
  - [message_channel_design.md](docs/design/message_channel_design.md) — 渠道架构：入站适配中台 + 出站推送 + 凭证引用
  - [lark_cli_integration.md](docs/design/lark_cli_integration.md) — 飞书 WS 指数退避 + 凭证用户级管理
- 【② Plan 落地快照（真实定稿）】
