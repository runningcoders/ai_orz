...
- [src/service/dal/cron_trigger.rs:37-74](file://src/service/dal/cron_trigger.rs#L37-L74)
...
- [src/service/domain/system/mod.rs:20-58](file://src/service/domain/system/mod.rs#L20-L58)
- [src/service/dal/cron_trigger.rs:13-32](file://src/service/dal/cron_trigger.rs#L13-L32)
...
- [src/service/domain/system/mod.rs:116-141](file://src/service/domain/system/mod.rs#L116-L141)
- [src/service/dal/cron_trigger.rs:76-177](file://src/service/dal/cron_trigger.rs#L76-L177)
- [src/producer/cron_trigger.rs:1-87](file://src/producer/cron_trigger.rs#L1-L87)
- [src/consumer/scheduler.rs:1-95](file://src/consumer/scheduler.rs#L1-L95)
- [migrations/20260711000000_cron_triggers.sql:1-25](file://migrations/20260711000000_cron_triggers.sql#L1-L25)
...
图表来源
- [src/handlers/system/cron_trigger/create_cron_trigger.rs:14-68](file://src/handlers/system/cron_trigger/create_cron_trigger.rs#L14-L68)
- [src/service/domain/system/mod.rs:207-259](file://src/service/domain/system/mod.rs#L207-L259)
- [src/service/dal/cron_trigger.rs:83-177](file://src/service/dal/cron_trigger.rs#L83-L177)
- [src/producer/cron_trigger.rs:26-87](file://src/producer/cron_trigger.rs#L26-L87)
- [src/consumer/scheduler.rs:39-95](file://src/consumer/scheduler.rs#L39-L95)
...
章节来源
- [src/models/cron_trigger.rs:10-65](file://src/models/cron_trigger.rs#L10-L65)
...
章节来源
- [src/service/dal/cron_trigger.rs:109-177](file://src/service/dal/cron_trigger.rs#L109-L177)
...
- [src/handlers/system/cron_trigger/get_cron_trigger.rs:11-25](file://src/handlers/system/cron_trigger/get_cron_trigger.rs#L11-L25)
- [src/handlers/system/cron_trigger/response.rs:8-125](file://src/handlers/system/cron_trigger/response.rs#L8-L125)
...
- 创建失败
  ...
  - 参考路径：[创建处理器:14-68](file://src/handlers/system/cron_trigger/create_cron_trigger.rs#L14-L68)
- 无法触发
  - 确认 is_enabled 是否为 1。
  - 检查 next_run_at 是否小于等于当前时间。
  - 参考路径：[DAL 标记执行逻辑:140-177](file://src/service/dal/cron_trigger.rs#L140-L177)
- 事件未消费
  - 确认 Consumer 已注册并订阅 cron.trigger。
  - 检查 payload 中的 action 是否被识别。
  - 参考路径：[消费者处理:53-95](file://src/consumer/scheduler.rs#L53-L95)
- 日志与统计
  - 可通过系统日志与 AOP 统计面板查看事件流转与队列状态。
  - 参考路径：[AOP 统计接口](file://src/service/domain/system/mod.rs:172-204)

章节来源
- [src/handlers/system/cron_trigger/create_cron_trigger.rs:14-68](file://src/handlers/system/cron_trigger/create_cron_trigger.rs#L14-L68)
- [src/service/dal/cron_trigger.rs:140-177](file://src/service/dal/cron_trigger.rs#L140-L177)
...
- [common/src/api/cron_trigger.rs:45-88](file://common/src/api/cron_trigger.rs#L45-L88)
- [src/handlers/system/cron_trigger/response.rs:64-105](file://src/handlers/system/cron_trigger/response.rs#L64-L105)
...
- 获取触发器
  ...
  - 参考路径：[获取处理器:11-25](file://src/handlers/system/cron_trigger/get_cron_trigger.rs#L11-L25)
- 更新触发器
  - 方法：PUT
  - 路径：/api/v1/system/cron-triggers/{trigger_id}
  - 请求体：UpdateCronTriggerRequest（可选字段覆盖）
  - 参考路径：[更新处理器:11-57](file://src/handlers/system/cron_trigger/update_cron_trigger.rs#L11-L57)
- 删除触发器
  - 方法：DELETE
  - 路径：/api/v1/system/cron-triggers/{trigger_id}
  - 参考路径：[删除处理器](file://src/handlers/system/cron_trigger/delete_cron_trigger.rs)
- 暂停触发器
  - 方法：POST
  - 路径：/api/v1/system/cron-triggers/{trigger_id}/pause
  - 参考路径：[暂停处理器](file://src/handlers/system/cron_trigger/pause_cron_trigger.rs)
- 恢复触发器
  - 方法：POST
  - 路径：/api/v1/system/cron-triggers/{trigger_id}/resume
  - 参考路径：[恢复处理器](file://src/handlers/system/cron_trigger/resume_cron_trigger.rs)
- 列出触发器
  - 方法：GET
  - 路径：/api/v1/system/cron-triggers
  - 查询参数：trigger_type、is_enabled、limit
  - 参考路径：[列表处理器](file://src/handlers/system/cron_trigger/list_cron_triggers.rs)
