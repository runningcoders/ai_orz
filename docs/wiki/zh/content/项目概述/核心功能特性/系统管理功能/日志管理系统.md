...
> 本长文是「日志管理系统」主题的 **入门概览层** 视角。同主题还有以下平行视角卡，请按需交叉阅读：
> - [日志管理系统（前端 UI 层）](docs/wiki/zh/content/前端应用/页面模块/系统管理页面/日志管理系统.md)
> - [日志管理系统（系统管理层）](docs/wiki/zh/content/功能模块/系统管理/日志管理系统.md)
...
- [src/service/domain/system/mod.rs:281-309](src/service/domain/system/mod.rs#L281-L309)
...
- [frontend/src/pages/system/logs.rs:67-153](frontend/src/pages/system/logs.rs#L67-L153)
...
**章节来源**
- [docs/logging_design.md:44-127](docs/logging_design.md#L44-L127)
...
- [src/handlers/system/logs/log_stats.rs:25-76](src/handlers/system/logs/log_stats.rs#L25-L76)
- [frontend/src/pages/system/logs.rs:23-45](frontend/src/pages/system/logs.rs#L23-L45)
...
**图示来源**
- [src/service/dal/log_query.rs:120-210](src/service/dal/log_query.rs#L120-L210)
- [src/service/dal/log_query.rs:260-361](src/service/dal/log_query.rs#L260-L361)
...
- [src/service/domain/system/mod.rs:281-284](src/service/domain/system/mod.rs#L281-L284)
- [src/service/dal/log_query.rs:120-210](src/service/dal/log_query.rs#L120-L210)
- [common/src/api/log_stats.rs:52-76](common/src/api/log_stats.rs#L52-L76)
...
- [src/service/dal/log_query.rs:330-361](src/service/dal/log_query.rs#L330-L361)
...
**章节来源**
- [src/service/dal/log_query.rs:112-118](src/service/dal/log_query.rs#L112-L118)
- [src/service/dal/log_query.rs:147-194](src/service/dal/log_query.rs#L147-L194)
...
**章节来源**
- [frontend/src/pages/system/logs.rs:426-441](frontend/src/pages/system/logs.rs#L426-L441)
- [src/handlers/system/logs/log_stats.rs:25-76](src/handlers/system/logs/log_stats.rs#L25-L76)