        ...
        nav { class: "navbar bg-neutral text-neutral-content sticky top-0 z-50 orz-navbar",
            ...
            if !is_mobile() {
                div { class: "flex-none flex items-center gap-1",
                    ...
                    Link { to: Route::MessageSearch {}, class: NAV_LINK_BASE,
                        span { "🔍" }
                        "消息搜索"
                    }
                    ...
                    div { class: "dropdown dropdown-end",
                        ...
                        ul {
                            ...
                            if is_admin {
                                ...
                                li { Link { to: Route::OrganizationContracts {}, "📜 联邦合约" } }
                            }
                            li { hr { class: "divider my-0" } }
                ...
                div { class: "drawer-side z-50",
                    ...
                    ul { class: "menu bg-base-100 text-base-content min-h-full w-80 p-4",
                        ...
                        if is_admin {
                            ...
                            li { Link { to: Route::OrganizationContracts {}, onclick: move |_| drawer_open.set(false), "📜 联邦合约" } }
                        }
