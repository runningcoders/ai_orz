...
//!
//! 共 8 个端点（用户侧 4 + 机器侧 4），统一前缀 `/api/v1/organization/links/*`。
...
pub mod list_federation_agents;
pub mod list_links;
pub mod revoke_link;
...
pub use list_federation_agents::list_federation_agents_handler;
pub use list_links::list_links_handler;
pub use revoke_link::revoke_link_handler;
