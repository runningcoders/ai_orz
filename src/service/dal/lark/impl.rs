//! 飞书 DAL 实现（LarkDalImpl）
//!
//! 实现 [`LarkCredentialDal`] 与 [`LarkListenerDal`] 全部子 trait
//! （由 mod.rs 的总 trait [`LarkDal`] 组合），承载飞书私信接入场景的
...
//! # 分层职责
//!
//! - **LarkDalImpl（本模块）**：纯数据访问 + 事件转换 + 监听编排
...
use super::LarkCredentialDal;
use super::LarkListenerDal;
...
// ==================== LarkCredentialDal 实现 ====================

#[async_trait::async_trait]
impl LarkCredentialDal for LarkDalImpl {
...
#[async_trait::async_trait]
impl LarkListenerDal for LarkDalImpl {
    ...
    async fn listener_stats(&self) -> common::api::LarkWsMetrics {
...
impl super::LarkDal for LarkDalImpl {}
