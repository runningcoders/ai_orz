...
fn new_test_db() -> rusqlite::Connection {
    ...
    conn.execute_batch(
        "CREATE TABLE IF NOT EXISTS agents (
            ...
            capabilities TEXT NOT NULL DEFAULT '[]', soul TEXT NOT NULL DEFAULT '',
            status INTEGER NOT NULL DEFAULT 1, created_by TEXT NOT NULL DEFAULT '',
            modified_by TEXT NOT NULL DEFAULT '', created_at INTEGER NOT NULL, updated_at INTEGER NOT NULL
        );",
    ).unwrap();
    conn
}
