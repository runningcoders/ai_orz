...
fn main() -> ExitCode {
    ...
    let replacements: Vec<(&str, &str)> = vec![
        ...
        (
            "docs/design/agent_loop_engine_design.md",
            "docs/archive/design-archive/agent_loop_engine_design.md",
        ),
        (
            "docs/design/agent_onboarding_design.md",
            "docs/archive/design-archive/agent_onboarding_design.md",
        ),
        (
            "docs/design/attachment_storage.md",
            "docs/archive/design-archive/attachment_storage.md",
        ),
        (
        ...
        (
            "docs/design/builtins_http_tool_design.md",
            "docs/archive/design-archive/builtins_http_tool_design.md",
        ),
        (
            "docs/design/canvas_rendering_playbook.md",
            "docs/archive/design-archive/canvas_rendering_playbook.md",
        ),
        (
        ...
        (
            "docs/design/external_agent_design.md",
            "docs/archive/design-archive/external_agent_design.md",
        ),
        (
        ...
        (
            "docs/design/generic_builtin_tools_design.md",
            "docs/archive/design-archive/generic_builtin_tools_design.md",
        ),
        (
            "docs/design/handler-tool-registration-macro.md",
        ...
        (
            "docs/design/mcp_tool_design.md",
        ...
        (
            "docs/design/message_interaction_design.md",
        ...
        (
            "docs/design/request_context_design.md",
            "docs/archive/design-archive/request_context_design.md",
        ),
        (
        ...
        (
            "docs/design/task_design.md",
            "docs/archive/design-archive/task_design.md",
        ),
        (
            "docs/design/task_scheduler_design.md",
            "docs/archive/design-archive/task_scheduler_design.md",
        ),
        (
            "docs/design/testing_guidelines.md",
            "docs/archive/design-archive/testing_guidelines.md",
        ),
        (
            "docs/design/tool_design.md",
            "docs/archive/design-archive/tool_design.md",
        ),
        (
            "docs/design/unified-idl-http-handler.md",
            "docs/archive/design-archive/unified-idl-http-handler.md",
        ),
        (
        ...
        // === PLAN ARCHIVE ===
        (
            "docs/plan/2026-08-15-文档规范与仓库精简.md",
            "docs/archive/plan-archive/文档规范与仓库精简.md",
        ),
        (
            "docs/plan/Agent 领域能力扩展工程.md",
            "docs/archive/plan-archive/Agent 领域能力扩展工程.md",
        ),
        (
            "docs/plan/Domain 层统一错误处理重构.md",
            "docs/archive/plan-archive/Domain 层统一错误处理重构.md",
        ),
        (
            "docs/plan/Playwright E2E 测试工程.md",
            "docs/archive/plan-archive/Playwright E2E 测试工程.md",
        ),
        (
            "docs/plan/init_base_data 扩展点全域覆盖.md",
            "docs/archive/plan-archive/init_base_data 扩展点全域覆盖.md",
        ),
        (
            "docs/plan/runtime_refactor_execution_draft.md",
            "docs/archive/plan-archive/runtime_refactor_execution_draft.md",
        ),
        (
            "docs/plan/sqlx_repository_layer_rewrite.md",
            "docs/archive/plan-archive/sqlx_repository_layer_rewrite.md",
        ),
        (
            "docs/plan/token_io_assets.md",
            "docs/archive/plan-archive/token_io_assets.md",
        ),
        (
            "docs/plan/两阶段启动幂等执行.md",
            "docs/archive/plan-archive/两阶段启动幂等执行.md",
        ),
        (
        ...
        (
            "docs/plan/任务模型标准化重构.md",
            "docs/archive/plan-archive/任务模型标准化重构.md",
        ),
        (
            "docs/plan/消息交互与 SSE 双向系统重构.md",
            "docs/archive/plan-archive/消息交互与 SSE 双向系统重构.md",
        ),
        (
            "docs/plan/飞书P2P消息集成.md",
            "docs/archive/plan-archive/飞书P2P消息集成.md",
        ),
        (
            "docs/plan/统计图表第三期.md",
            "docs/archive/plan-archive/统计图表第三期.md",
        ),
        (
            "docs/plan/统计图表Phase2.md",
        ...
        (
            "docs/plan/architecture_status_20260725.md",
            "docs/archive/plan-archive/architecture_status_20260725.md",
        ),
        // === STRAYS ===
        (
            "docs/archive/a2a_server_design.md",
            "docs/archive/design-archive/a2a_server_design.md",
        ),
        (
            "docs/archive/runtime-domain-roadmap.md",
            "docs/archive/design-archive/runtime-domain-roadmap.md",
        ),
        (
            "docs/archive/handler_management_api_plan.md",
            "docs/archive/plan-archive/handler_management_api_plan.md",
        ),
        (
            "docs/archive/test_supplement_plan_20260514.md",
            "docs/archive/plan-archive/test_supplement_plan_20260514.md",
        ),
        (
            "docs/archive/frontend_roadmap.md",
            "docs/archive/plan-archive/frontend_roadmap.md",
        ),
        (
            "docs/archive/todo-archive-2026-08-15.md",
            "docs/archive/plan-archive/todo-archive-2026-08-15.md",
        ),
    ];
